...
TEST_F(SemanticReasonerGTests, conceptSet_conceptToChildConcepts) {
    ...
    }
    {
        ...
        EXPECT_EQ("duration_day", concepts[0]);
        EXPECT_EQ("duration_day_*", concepts[1]);
        EXPECT_EQ("duration_hour", concepts[2]);
        EXPECT_EQ("duration_hour_*", concepts[3]);
        EXPECT_EQ("duration_millisecond", concepts[4]);
        EXPECT_EQ("duration_millisecond_*", concepts[5]);
        EXPECT_EQ("duration_minute", concepts[6]);
        EXPECT_EQ("duration_minute_*", concepts[7]);
