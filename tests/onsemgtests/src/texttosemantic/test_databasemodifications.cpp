...
TEST_F(SemanticReasonerGTests, addNewWordsAndConcepts) {
    ...
    // add a word
    {
        const SemanticGenericGrounding objectGenGrd = _getObjectGenGrd(likeSentence, lingDb);
    ...
    {
        const std::map<std::string, char> concepts = _getRootConcepts(beVerbSentence, lingDb);
...
TEST_F(SemanticReasonerGTests, addNewTranslations) {
    ...
    ASSERT_EQ("Paul is a nouvMot en français.",
              _getTranslation("Paul est un nouvMot en français", lingDb, SemanticLanguageEnum::ENGLISH));
    ...
    // translate an existing word
    {
        ...
        ONSEM_ANSWER_EQ("Paul painted a horseNewWord.", operator_answer("What did Paul paint", userSemExp, lingDb));
    }
}
...
TEST_F(SemanticReasonerGTests, considerContextInfos) {
    ...
    EXPECT_EQ("I like Dede test_bla_bla.",
              _getTranslation("I like test_bla_bla Dede", lingDb, SemanticLanguageEnum::ENGLISH));
    ...
    EXPECT_EQ("I like test_bla_bla Dede.",
              _getTranslation("I like test_bla_bla Dede", lingDb, SemanticLanguageEnum::ENGLISH));
}
...
TEST_F(SemanticReasonerGTests, considerInflectedWordFrequency) {
    ...
    EXPECT_EQ("I like Dede Test_bla_bla1.",
              _getTranslation("I like Dede test_bla_bla1", lingDb, SemanticLanguageEnum::ENGLISH));
    ...
    EXPECT_EQ("I like Dede test_bla_bla2.",
              _getTranslation("I like Dede test_bla_bla2", lingDb, SemanticLanguageEnum::ENGLISH));
}
