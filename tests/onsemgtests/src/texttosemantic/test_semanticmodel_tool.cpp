...
TEST_F(SemanticReasonerGTests, listGroundedExpressions) {
    auto semExp = textToSemExp(
        "rajouter une fonctionnalité et rajouter un test automatique", *lingDbPtr, SemanticLanguageEnum::FRENCH);
...
TEST_P(SemanticModifierTestWithRequestType, addRequestToGroundedExpression) {
    auto semExp = textToSemExp("grand-mère sait faire un bon café", *lingDbPtr, SemanticLanguageEnum::FRENCH);
...
INSTANTIATE_TEST_CASE_P(SemanticRequestTypeBased,
                        SemanticModifierTestWithRequestType,
                        ::testing::Values(SemanticRequestType::ACTION,
                                          SemanticRequestType::CAUSE,
                                          SemanticRequestType::YESORNO,
                                          SemanticRequestType::CHOICE,
                                          SemanticRequestType::LOCATION,
                                          SemanticRequestType::MANNER,
                                          SemanticRequestType::NOTHING,
                                          SemanticRequestType::OBJECT,
                                          SemanticRequestType::PURPOSE,
                                          SemanticRequestType::QUANTITY,
                                          SemanticRequestType::SUBJECT,
                                          SemanticRequestType::TIME,
