...
TEST_F(SemanticReasonerGTests, test_naturalLanguageExpressionToSemanticExpression) {
    ...
    getCompanyInfoNle.word = NaturalLanguageText(
        "to get information about the company", NaturalLanguageTypeOfText::EXPRESSION, SemanticLanguageEnum::ENGLISH);
    ...
    paulWantsToGetCompanyInfoNle.word =
        NaturalLanguageText("want", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    paulCannotBeIdentifiedNle.word =
        NaturalLanguageText("identify", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    iAmLocalizedNle.word =
        NaturalLanguageText("localize", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    paulShouldWashHandsNle.word =
        NaturalLanguageText("wash", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    paulShouldWearAnUmbrellaNle.word =
        NaturalLanguageText("wear", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    lunchIsAfterMorningNle.word =
        NaturalLanguageText("be~after", NaturalLanguageTypeOfText::VERB, SemanticLanguageEnum::ENGLISH);
    ...
    aRandomQuoteNle.word =
        NaturalLanguageText("Aa bb ok ffsgsg", NaturalLanguageTypeOfText::QUOTE, SemanticLanguageEnum::UNKNOWN);

    NaturalLanguageExpression resourceExNle;
    resourceExNle.word = NaturalLanguageText(
        "\\resLabel=resValue\\", NaturalLanguageTypeOfText::EXPRESSION, SemanticLanguageEnum::ENGLISH);
    ...
    EXPECT_EQ("You want to get information about the company.",
              semExpToText(semExp1->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Tu veux obtenir des informations sur l'entreprise.",
              semExpToText(semExp1->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    EXPECT_EQ("You can't be identified.",
              semExpToText(semExp2->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Tu ne peux pas être identifié.",
              semExpToText(semExp2->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    ONSEM_ANSWER_EQ("No, you can't be identified.", operator_answer("Can I be identified?", semMem, lingDb));
    ...
    EXPECT_EQ("I am localized.", semExpToText(semExp3->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Je suis localisé.", semExpToText(semExp3->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    ONSEM_ANSWER_EQ("Yes, I am localized.", operator_answer("Are you localized?", semMem, lingDb));
    ONSEM_ANSWER_EQ("Oui, je suis localisé.", operator_answer("Es-tu localisé ?", semMem, lingDb));
    ...
    EXPECT_EQ("You should wash your hands.",
              semExpToText(semExp4->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Tu devrais laver tes mains.",
              semExpToText(semExp4->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    ONSEM_ANSWER_EQ("Yes, you should wash your hands.", operator_answer("Should I wash my hands?", semMem, lingDb));
    ...
    EXPECT_EQ("You should wear an umbrella.",
              semExpToText(semExp5->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Tu devrais porter un parapluie.",
              semExpToText(semExp5->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    ONSEM_ANSWER_EQ("Yes, you should wear an umbrella.", operator_answer("Should I wear an umbrella?", semMem, lingDb));
    ...
    EXPECT_EQ(aRandomQuoteNle.word.text, semExpToText(semExp6->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ(aRandomQuoteNle.word.text, semExpToText(semExp6->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
    ...
    EXPECT_EQ("\\resLabel=resValue\\", executionDataOutputter.rootExecutionData.run(semMem, lingDb));
    ...
    EXPECT_EQ("Lunch time is after morning.",
              semExpToText(semExp8->clone(), SemanticLanguageEnum::ENGLISH, semMem, lingDb));
    EXPECT_EQ("Le temps de déjeuner est après le matin.",
              semExpToText(semExp8->clone(), SemanticLanguageEnum::FRENCH, semMem, lingDb));
}
