...
TEST_F(SemanticReasonerGTests, test_scenarios) {
    ...
    std::string bilan;
    bool someScenariosHaveChanged = scenarioContainer.compareScenariosToReferenceResults(
        bilan, inputScenariosFolder, outputScenariosFolder, &getResultOfAScenario, *lingDbPtr);
    std::cout << "\n" << bilan << std::endl;
