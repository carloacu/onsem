...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canAnswerIDontKnow) {
    ...
    ONSEM_ANSWERNOTFOUND_EQ(
        "I don't know what Paul likes.",
        operator_react(questionStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canAnswerIDontKnowReaction));
    ONSEM_NOANSWER(
        operator_react(questionStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotAnswerIDontKnowReaction));

    const std::string orderFrStr = "saute";
    ONSEM_BEHAVIORNOTFOUND_EQ(
        "Je ne sais pas sauter.",
        operator_react(orderFrStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canAnswerIDontKnowReaction));
    ONSEM_NOANSWER(
        operator_react(orderFrStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannnotAnswerIDontKnowReaction));
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canDoProactivity) {
    ...
    ONSEM_QUESTION_EQ("Pourquoi aimes-tu cette voiture ?",
                      operator_react(sentenceToTriggerProactivityFrStr,
                                     semMem,
                                     lingDb,
                                     SemanticLanguageEnum::FRENCH,
                                     &canDoProactivityReaction));
    ONSEM_NOANSWER(operator_react(
        sentenceToTriggerProactivityFrStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotDoProactivityReaction));

    const std::string garbageSentenceStr = "dfgdfg";
    ONSEM_NOANSWER(
        operator_react(garbageSentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotDoProactivityReaction));
    ONSEM_NOANSWER(
        operator_react(garbageSentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canDoProactivityReaction));
    canDoProactivityReaction.canReactToANoun = true;
    ONSEM_QUESTION_EQ(
        "Qu'est-ce que dfgdfg ?",
        operator_react(garbageSentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canDoProactivityReaction));
    canDoProactivityReaction.canReactToANoun = false;

    ONSEM_NOANSWER(operator_react(
        "twingo est une voiture", semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotDoProactivityReaction));
    ONSEM_NOANSWER(operator_react("twingo", semMem, lingDb, SemanticLanguageEnum::FRENCH, &canDoProactivityReaction));
    canDoProactivityReaction.canReactToANoun = true;
    ONSEM_ANSWER_EQ("Twingo est une voiture.",
                    operator_react("twingo", semMem, lingDb, SemanticLanguageEnum::FRENCH, &canDoProactivityReaction));
    ONSEM_NOANSWER(
        operator_react("twingo", semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotDoProactivityReaction));
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canAnswerWithATrigger) {
    ...
    // from a nominal group
    {
        ...
        ONSEM_NOANSWER(operator_react(
            nominalGroupTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotAnswerWithATriggerReaction));
        ONSEM_ANSWER_EQ(
            "Gad is a humorist.",
            operator_react(
                nominalGroupTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canAnswerWithATriggerReaction));
    }
    ...
    // from a question
    {
        ...
        ONSEM_ANSWERNOTFOUND_EQ(
            "I don't know what Gad likes.",
            operator_react(
                questionTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotAnswerWithATriggerReaction));
        ONSEM_ANSWER_EQ(
            answerOfQuestion,
            operator_react(
                questionTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canAnswerWithATriggerReaction));
    }
    ...
    // from a affirmation
    {
        ...
        ONSEM_QUESTION_EQ(
            "Why is Gad a nice man?",
            operator_react(
                affirmationTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotAnswerWithATriggerReaction));
        ONSEM_ANSWER_EQ(
            "I also like Gad.",
            operator_react(
                affirmationTrigger, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canAnswerWithATriggerReaction));
    }
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canAnswerWithAllTheTriggers) {
...

    {
        ...
        ONSEM_ANSWER_EQ(
            "Réponse 1\tTHEN\tRéponse 2",
            operator_react(nominalGroupTrigger1, semMem, lingDb, langauge, &canAnswerWithAllTheTriggersReaction));
        ONSEM_ANSWER_EQ(
            "Réponse 1",
            operator_react(nominalGroupTrigger1, semMem, lingDb, langauge, &cannotAnswerWithAllTheTriggersReaction));
    }
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canReactToANoun) {
    ...
    const std::string garbageSentenceStr = "dfgdfg";
    ONSEM_NOANSWER(
        operator_react(garbageSentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotReactToANoun));
    ONSEM_QUESTION_EQ(
        "Qu'est-ce que dfgdfg ?",
        operator_react(garbageSentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canReactToANoun));

    ONSEM_FEEDBACK_EQ("C'est pas faux.", operator_react("twingo est une voiture", semMem, lingDb));
    ONSEM_NOANSWER(operator_react("twingo", semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotReactToANoun));
    ONSEM_ANSWER_EQ("Twingo est une voiture.",
                    operator_react("twingo", semMem, lingDb, SemanticLanguageEnum::FRENCH, &canReactToANoun));
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canSayOkToAnAffirmation) {
    ...
    ONSEM_NOANSWER(
        operator_react(sentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannotSayOkToAnAffirmation));
    semMem.clear();
    ONSEM_FEEDBACK_EQ(
        "Ok, tu es grand.",
        operator_react(sentenceStr, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canSayOkToAnAffirmation));
}
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_canAnswerWithExternalEngines) {
    ...
    ONSEM_ANSWERNOTFOUND_EQ(
        "I don't know what the joke of today is.",
        operator_react(
            question, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotAnswerWithExternalEnginesReaction));
    ONSEM_ANSWER_EQ(
        "The joke of today is " + DummyJokeProvider::englishJoke(),
        operator_react(question, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canAnswerWithExternalEnginesReaction));
...
TEST_F(SemanticReasonerGTests, operator_reactionOptions_mergeTextAnResource) {
    ...
    ONSEM_ANSWER_EQ(
        "N5 likes to talk with you.",
        operator_react(whoIsN5Str, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        videoResource1Str,
        operator_react(
            questionTriggerStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotMergeTextAndResourceReaction));
    ONSEM_ANSWER_EQ(
        videoResource1Str + "\tTHEN\tGad likes the humanity well-being.",
        operator_react(
            questionTriggerStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        ...
        operator_react(
            questionTriggerStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &cannnotMergeTextAndResourceReaction));
    ONSEM_ANSWER_EQ(
        videoResource1Str + "\tTHEN\tGad likes me.",
        operator_react(
            questionTriggerStr, semMem, lingDb, SemanticLanguageEnum::ENGLISH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        "Gad est un humoriste.",
        operator_react(
            questionTrigger2Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannnotMergeTextAndResourceReaction));
    ONSEM_ANSWER_EQ(
        "Gad est un humoriste.",
        operator_react(
            questionTrigger2Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        ...
        operator_react(
            questionTrigger2Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannnotMergeTextAndResourceReaction));
    ONSEM_ANSWER_EQ(
        videoResource2Str + "\tTHEN\tGad est un humoriste.",
        operator_react(
            questionTrigger2Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        videoResource2Str + "\tTHEN\tGad est un humoriste.",
        operator_react("Gad", semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_BEHAVIOR_EQ(
        videoResource3Str,
        operator_react(
            questionTrigger3Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannnotMergeTextAndResourceReaction));
    ONSEM_BEHAVIOR_EQ(
        videoResource3Str,
        operator_react(
            questionTrigger3Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        videoResource4Str,
        operator_react(
            questionTrigger4Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &cannnotMergeTextAndResourceReaction));
    ONSEM_ANSWER_EQ(
        videoResource4Str,
        operator_react(
            questionTrigger4Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
    ...
    ONSEM_ANSWER_EQ(
        "Cool, où était-elle ?",
        operator_react(
            questionTrigger5Str, semMem, lingDb, SemanticLanguageEnum::FRENCH, &canMergeTextAndResourceReaction));
}
