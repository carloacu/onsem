...
ImbricationType _getImbrication(const std::string& pStr1,
    ...
    auto res = SemExpComparator::getSemExpsImbrications(
        semExp1, semExp2, pSemanticMemory.memBloc, pLingDb, nullptr, pComparisonErrorReportingPtr);
    auto resOtherSide =
        SemExpComparator::getSemExpsImbrications(semExp2, semExp1, pSemanticMemory.memBloc, pLingDb, nullptr);
...
TEST_F(SemanticReasonerGTests, test_imbrication_basic) {
    ...
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("I don't like banana", "I dislike banana", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS, _getImbrication("I like banana", "I am fond of banana", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("a man and a woman", "a man and a woman", semanticMemory, lingDb));
    ...
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("le 3 septembre 1986", "le 3 septembre 1986", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("si tu es content dis bonjour", "si tu es content dis bonjour", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("Je veux une assurance habitation", "I want a home insurance", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication(
                  "Je veux une assurance habitation", "Je voudrais une assurance habitation", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS, _getImbrication("et puis", "Et après", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("Qu'est-ce que la Toussaint ?", "Qu'est-ce que la toussaint ?", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("Qu'est-ce que l'ascension ?", "Qu'est-ce que l'Ascension ?", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::EQUALS,
              _getImbrication("Start robotbehav application",
                              "Start Robotbehav application",
                              semanticMemory,
                              lingDb,
    ...
    EXPECT_EQ(ImbricationType::CONTAINS,
              _getImbrication(
                  "si tout le monde est content dis bonjour", "si tu es content dis bonjour", semanticMemory, lingDb));
    ...
    EXPECT_EQ(ImbricationType::HYPONYM,
              _getImbrication("je m'aime", "quelqu'un aime quelqu'un", semanticMemory, lingDb));

    EXPECT_EQ(ImbricationType::HYPERNYM,
              _getImbrication("I say rub your head", "I ask rub your head", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::HYPERNYM, _getImbrication("I call \\p_agent=1\\", "I call you", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::HYPERNYM,
              _getImbrication("I call \\p_agent=1\\ by phone", "I call you by phone", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::HYPERNYM, _getImbrication("a person", "me", semanticMemory, lingDb));

    EXPECT_EQ(ImbricationType::MORE_DETAILED,
              _getImbrication("le 3 septembre 1986", "septembre 1986", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED, _getImbrication("I look left", "I look", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED,
              _getImbrication("somebody touches your left hand", "your left hand is touched", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED, _getImbrication("your right elbow", "your body", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED,
              _getImbrication("si tu es content dis bonjour sinon dis au revoir",
                              "si tu es content dis bonjour",
                              semanticMemory,
                              lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED, _getImbrication("the dance Macarena", "a dance", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::MORE_DETAILED,
              _getImbrication("a N5 robot", "a N5", semanticMemory, lingDb, SemanticLanguageEnum::ENGLISH));
    EXPECT_EQ(ImbricationType::MORE_DETAILED,
              _getImbrication("a N5 robot", "a n5", semanticMemory, lingDb, SemanticLanguageEnum::ENGLISH));

    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("septembre", "le 3 septembre 1986", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("Paul ira à Paris", "Paul ira à Paris. Pierre aime les fleurs", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("Paul ira à Paris", "Paul ira à Paris en janvier", semanticMemory, lingDb));
    ...
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("I bought a N5", "I bought a N5 robot", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("I bought N5", "I bought N5 robot", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("je vais faire des courses au supermarché",
                              "je vais faire des courses au supermarché demain",
                              semanticMemory,
                              lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("The volume", "The volume level.", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::LESS_DETAILED,
              _getImbrication("Reduce the volume", "Reduce the volume level.", semanticMemory, lingDb));
    ...
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("Il est né en 1988", "Il est né le 5 mai 1986", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("le 3 septembre 1986", "septembre 1987", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("le 3 septembre 1986", "le 4 septembre 1986", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("@karim-boudjema", "deux joueurs de tennis Vijay Amritraj", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS, _getImbrication("Abderrahim", "un conseiller", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("j'aime quelqu'un", "quelqu'un m'aime", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS, _getImbrication("je marche", "je fais un gâteau", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("I say rub your head", "I don't ask rub your head", semanticMemory, lingDb));
    ...
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("a man and a woman", "a man or a woman", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("Your battery is nearly empty", "Your battery is low", semanticMemory, lingDb));
    EXPECT_EQ(ImbricationType::DIFFERS,
              _getImbrication("I asked walk", "I said walk yesterday", semanticMemory, lingDb));
}
...
TEST_F(SemanticReasonerGTests, test_imbrication_errorReporting) {
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::MORE_DETAILED,
                  _getImbrication("Does Paul like banana and bear?",
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::LESS_DETAILED,
                  _getImbrication("Baisse la température",
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::LESS_DETAILED,
                  _getImbrication("Descends le volume",
                                  "Descends ton volume",
                                  semanticMemory,
                                  lingDb,
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::DIFFERS,
                  _getImbrication("Can you look up ?",
                                  "Could you look up ?",
                                  semanticMemory,
                                  lingDb,
                                  SemanticLanguageEnum::ENGLISH,
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::MORE_DETAILED,
                  _getImbrication("raconte moi quelque chose de joyeux",
                                  "Dis quelque chose",
                                  semanticMemory,
                                  lingDb,
                                  SemanticLanguageEnum::UNKNOWN,
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::LESS_DETAILED,
                  _getImbrication("Raconte une histoire",
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::DIFFERS,
                  _getImbrication("Raconte une histoire joyeuse",
                                  "Raconte une histoire triste",
                                  semanticMemory,
                                  lingDb,
                                  SemanticLanguageEnum::UNKNOWN,
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::LESS_DETAILED,
                  _getImbrication("Peux-tu nous raconter une blague",
...

    {
        SemExpComparator::ComparisonErrorReporting comparisonErrorReporting;
        EXPECT_EQ(ImbricationType::DIFFERS,
                  _getImbrication("Avance à Paris",
                                  "Avance de 3 mètres",
                                  semanticMemory,
                                  lingDb,
                                  SemanticLanguageEnum::UNKNOWN,
...

    {
        ...
        EXPECT_EQ(ImbricationType::DIFFERS,
                  _getImbrication("I avance a lttle",
                                  "I advanced",
                                  semanticMemory,
                                  lingDb,
                                  SemanticLanguageEnum::UNKNOWN,
