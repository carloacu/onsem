...
TEST_F(SemanticReasonerGTests, operator_isASubpart_basic) {
    ...
    EXPECT_TRUE(
        _operator_isASubPart("regarde à droite et dis bonjour", "regarde vers la droite", semanticMemory, lingDb));
    EXPECT_TRUE(_operator_isASubPart("regarde à droite et dis bonjour", "regarde à droite", semanticMemory, lingDb));
    EXPECT_TRUE(
        _operator_isASubPart("dis bonjour et regarde à droite", "regarde vers la droite", semanticMemory, lingDb));
