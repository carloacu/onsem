...
TEST_F(SemanticReasonerGTests, operator_answer_basic) {
    ...
    ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas si j'aime le chocolat.",
                            operator_answer("tu aimes le chocolat ?", semMem, lingDb));
    ...
    {
        operator_inform(
            "\\" + resourceLabelForTests_url + "=https://www.youtube.com/v/4QpjSWndmqA\\ is the life of Gustave.",
            semMem,
            lingDb);
        ...
        ONSEM_ANSWERNOTFOUND_EQ("I don't know what Gustavo's life is.",
                                operator_answer("what is the life of Gustavo?", semMem, lingDb));
    }
    ...
    {
        operator_inform(
            "André Thunberg is \\" + resourceLabelForTests_url + "=https://www.youtube.com/v/5_ncIrrM8S0\\.",
            semMem,
            lingDb);
        ONSEM_ANSWER_EQ("André Thunberg is https://www.youtube.com/v/5_ncIrrM8S0",
                        operator_answer("Who is André Thunberg", semMem, lingDb));

        operator_inform(
            "\\" + resourceLabelForTests_url + "=https://www.youtube.com/v/U51us-be7GQ\\ is Lauren.", semMem, lingDb);
        ONSEM_ANSWER_EQ("Lauren is https://www.youtube.com/v/U51us-be7GQ",
                        operator_answer("who is Lauren?", semMem, lingDb));
    }
    ...
    // answer from the subject of a question
    {
        ...
        ONSEM_ANSWER_EQ("La couleur de ton chat est bleue.",
                        operator_answer("quel est la couleur de mon chat", semMem, lingDb));
    }
    ...
    // take the verb tense into account
    {
        ...
        ONSEM_ANSWER_EQ("I smile.", operator_answer("what do you do ?", semMem, lingDb));
        ONSEM_ANSWER_EQ("I looked at you.", operator_answer("what did you do ?", semMem, lingDb));
        ONSEM_ANSWER_EQ("I will run and I will raise my left arm.",
                        operator_answer("what will you do ?", semMem, lingDb));
    }
    ...
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas pourquoi je suis sur terre.",
                                operator_answer("pourquoi es-tu sur terre ?", semMem, lingDb));
    ...
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas si Paul est assis par terre pour manger.",
                                operator_answer("Paul est assis par terre pour manger ?", semMem, lingDb));
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas si Paul est assis par terre pour jouer.",
                                operator_answer("Paul est assis par terre pour jouer ?", semMem, lingDb));
        operator_inform("Paul est assis par terre pour jouer", semMem, lingDb);
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas si Paul est assis par terre pour manger.",
                                operator_answer("Paul est assis par terre pour manger ?", semMem, lingDb));
        ONSEM_ANSWER_EQ("Oui, Paul est assis par terre pour jouer.",
                        operator_answer("Paul est assis par terre pour jouer ?", semMem, lingDb));
    }

    // who answer
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas qui habite à Lyon.",
                                operator_answer("qui habite à Lyon ?", semMem, lingDb));
    ...
    // what answer
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas ce qui est blanc.",
                                operator_answer("qu'est-ce qui est blanc ?", semMem, lingDb));
        ...
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas ce que c'est une pomme.",
                                operator_answer("qu'est-ce qu'une pomme ?", semMem, lingDb));
    ...
    // cause answer
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas pourquoi Paul est content.",
    ...
    // time answer
    {
        ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas quand tu es content.",
                                operator_answer("quand je suis content ?", semMem, lingDb));
    ...
    // duration answer
    {
        ...
        ONSEM_ANSWER_EQ("The trip will last 7 hours.", operator_answer("How long will the trip last", semMem, lingDb));
    ...
    // date time answer
    {
        ...
        ONSEM_ANSWER_EQ("Stanislas a eu le bac le 12 mai 1998.",
                        operator_answer("Quand Stanislas a eu le bac ?", semMem, lingDb));
        operator_inform("Le 42 mai 1990, Gustave a eu le bac.", semMem, lingDb);    // test with a day out of range
        ONSEM_ANSWER_EQ("Gustave a eu le bac en mai 1990.",
                        operator_answer("Quand Gustave a eu le bac ?", semMem, lingDb));
        operator_inform("Le 12 février, Théodore a eu le bac.", semMem, lingDb);    // date without year
        ONSEM_ANSWER_EQ("Théodore a eu le bac le 12 février.",
                        operator_answer("Quand Théodore a eu le bac ?", semMem, lingDb));
        operator_inform("Le 31 février 1998, Constantin a eu le bac.",
                        semMem,
                        lingDb);    // day number between 1 and 31 but the date is wrong
        ONSEM_ANSWER_EQ("Constantin a eu le bac le 31 février 1998.",
                        operator_answer("Quand Constantin a eu le bac ?", semMem, lingDb));
    }

    // location answer
    {
        ONSEM_ANSWERNOTFOUND_EQ("I don't know if you are on floor.",
                                operator_answer("am I on the floor?", semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("Tu manges dans la cuisine et à l'école.",
                        operator_answer("où est-ce que je mange", semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("Paul est connu en Allemagne.",
                        operator_answer("où est-ce que Paul est connu", semMem, lingDb));
    ...
    {
        ONSEM_ANSWERNOTFOUND_EQ("I don't know how your robot's battery is.",
    ...
    // answer to question "do you know ..."
    {
        ...
        ONSEM_ANSWER_EQ("No, I don't know you.", operator_answer("Do you know me ?", semMem2, lingDb));
        operator_inform("I am Renauld", semMem2, lingDb);
        ONSEM_ANSWER_EQ("Yes, I know you.", operator_answer("Do you know me ?", semMem2, lingDb));
    }
    ...
    { ONSEM_ANSWER_EQ("No, I don't know any story.", operator_answer("do you know a story", semMem, lingDb)); }
...

    {
        ...
        ONSEM_ANSWER_EQ("You are 6.", operator_answer("how old am I", semMem, lingDb));
        ONSEM_ANSWER_EQ("Your age is 6.", operator_answer("what is my age", semMem, lingDb));
        ONSEM_ANSWER_EQ("Tu as 6 ans.", operator_answer("quel est mon age", semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("You are 7.", operator_answer("how old am I", semMem, lingDb));
    }
    ...
    // owner synthesis
    {
        ...
        ONSEM_ANSWER_EQ(julietSoudWshHerHands, operator_answer("What Juliet should do", semMem, lingDb));
...

    {
        ...
        ONSEM_ANSWER_EQ("Thérèse a joué 3 fois.", operator_answer("Combien de fois Thérèse a joué ?", semMem, lingDb));
    }

    {
        ...
        ONSEM_ANSWER_EQ("Tu dois avancer 400 centimètres.",
        ...
        ONSEM_ANSWERNOTFOUND_EQ(
            "Je ne sais pas combien tu dois aller vers l'avant en centimètres.",
...
TEST_F(SemanticReasonerGTests, operator_answer_choice) {
...

    {
        ...
        ONSEM_ANSWER_EQ("Ni l'un ni l'autre, je suis un robot.",
                        operator_answer("Es-tu un homme ou une femme", semMem, lingDb));
    }
...

    {
        ...
        ONSEM_ANSWERNOTFOUND_EQ("I don't know if you like chocolate or banana.",
                                operator_answer(question, semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("Ni l'un ni l'autre", operator_answer("j'aime le chocolat ou la banane ?", semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("You like butter.", operator_answer("Do I like chocolate, butter or banana?", semMem, lingDb));
        ...
        ONSEM_ANSWER_EQ("None of them", operator_answer("Do I like chocolate, butter or banana?", semMem, lingDb));
...
TEST_F(SemanticReasonerGTests, operator_answer_whatIsAction) {
    ...
    ONSEM_ANSWER_EQ("To say something is something.", operator_answer("what is to say something?", semMem, lingDb));
    ...
    ONSEM_ANSWERNOTFOUND_EQ("I don't know what is to smile.", operator_answer("what is to smile?", semMem, lingDb));
}
...
TEST_F(SemanticReasonerGTests, operator_answer_whitoutIdontKnowAnswer) {
    ...
    ONSEM_ANSWERNOTFOUND_EQ("I don't know if I am happy.", operator_answer("Are you happy?", semMem, lingDb, true));
    operator_inform("You are happy.", semMem, lingDb);
    ONSEM_ANSWER_EQ("Yes, I am happy.", operator_answer("Are you happy?", semMem, lingDb, false));
    ONSEM_ANSWER_EQ("Yes, I am happy.", operator_answer("Are you happy?", semMem, lingDb, true));
}
...
TEST_F(SemanticReasonerGTests, operator_answer_from_sub_part_of_a_date) {
    ...
    ONSEM_ANSWER_EQ("Bart", operator_answer("qui est né le 7 septembre 1988", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Bart", operator_answer("Qui est né en 1988", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Bart", operator_answer("Qui est né en mille neuf cents quatre-vingts huit", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Bart", operator_answer("Qui est né en septembre", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Bart", operator_answer("Qui est né en septembre 1988", semMem, lingDb, true));
...
TEST_F(SemanticReasonerGTests, operator_answer_reply_composed_of_many_sentence_1) {
    ...
    ONSEM_ANSWER_EQ("Oui, Bruno aime un informaticien.", operator_answer(questionStr, semMem, lingDb, true));
}
...
TEST_F(SemanticReasonerGTests, operator_answer_withAQuestionWithSubordinates) {
    ...
    operator_inform(
        "Danilo Luiz da Silva, dit Danilo, né le 15 juillet 1991 à Bicas, dans l'État de Minas Gerais au Brésil, est "
        "un footballeur international brésilien, évoluant au poste de latéral ou milieu droit à la Juventus.",
        semMem,
        lingDb);
    operator_inform("Jason Young, né le 21 mars 1991, est un athlète jamaïcain", semMem, lingDb);
    operator_inform("José Javier del Aguila (né le 7 mars 1991 au Guatemala) est un joueur de football international "
                    "guatémaltèque, qui évolue au poste de milieu de terrain.",
                    semMem,
                    lingDb);
    operator_inform("Usain Bolt, né le 21 août 1986 dans la paroisse de Trelawny, est un athlète jamaïcain, "
                    "spécialiste des épreuves de sprint.",
                    semMem,
                    lingDb);
    operator_inform(
        "Zinédine Zidane, né le 23 juin 1972 à Marseille, est un footballeur international français", semMem, lingDb);
    ...
    ONSEM_ANSWER_EQ("Zinédine Zidane", operator_answer("qui est né le 23 juin 1972", semMem, lingDb, true));
    ...
    ONSEM_ANSWER_EQ("Jason Young et Usain Bolt", operator_answer("qui est un athlète", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Jason Young et Usain Bolt", operator_answer("qui est un athlète jamaïcain", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Jason Young", operator_answer("qui est un athlète né le 21 mars 1991", semMem, lingDb, true));
    ...
    ONSEM_ANSWER_EQ("Oui, Toto aime un footballeur.",
                    operator_answer("Toto aime un footballeur ?", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Toto", operator_answer("qui aime un footballeur", semMem, lingDb, true));
    ONSEM_ANSWER_EQ("Toto", operator_answer("qui aime un footballeur né en mars 1991", semMem, lingDb, true));

    operator_inform("Raphael est né le 7 novembre 1975.", semMem, lingDb);
    ONSEM_ANSWER_EQ("Raphael", operator_answer("qui est né en novembre 1975", semMem, lingDb, true));
    ...
    ONSEM_ANSWER_EQ("Raphael", operator_answer(xhoIsASingerBornInNomber1975, semMem, lingDb, true));
