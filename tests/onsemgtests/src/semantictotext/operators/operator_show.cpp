...
TEST_F(SemanticReasonerGTests, operator_show_basic) {
    ...
    operator_inform(
        "\\" + resourceLabelForTests_url + "=#en_US#" + singEnUrlStr + "\\ is a woman singing", semMem, lingDb);
    operator_inform(
        "\\" + resourceLabelForTests_url + "=#fr_FR#" + singFrUrlStr + "\\ is a woman singing", semMem, lingDb);
    {
