...
TEST_F(SemanticReasonerGTests, operator_reactOnRoboticSentences) {
    ...
    // current activity
    ONSEM_ANSWERNOTFOUND_EQ("I don't know what I am executing.",
                            operator_react("what are you executing?", semMem, lingDb));
    ...
    ONSEM_ANSWERNOTFOUND_EQ("I don't know if I hear a speech.",
                            operator_react("Are you hearing a speech", semMem, lingDb));
    ...
    ONSEM_ANSWERNOTFOUND_EQ("I don't know why I started \"thriller\".",
                            operator_react("Why did you start \"thriller\"?", semMem, lingDb));
    operator_inform_fromRobot("I started \"thriller\" because I was turned on", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller\" because I was turned on.",
                    operator_react("Why did you start \"thriller\"?", semMem, lingDb));
    operator_inform_fromRobot("I started \"thriller2\" because the trigger condition was true", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller2\" because the trigger condition was true.",
                    operator_react("Why did you start \"thriller2\"?", semMem, lingDb));
    operator_inform_fromRobot("I started \"thriller3\" because you asked me orally", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller3\" because you asked me orally.",
                    operator_react("Why did you start \"thriller3\"?", semMem, lingDb));
    operator_inform_fromRobot(
        "I started \"thriller4\" because you trigger the application by the tablet", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller4\" because you trigger the application by the tablet.",
                    operator_react("Why did you start \"thriller4\"?", semMem, lingDb));
    operator_inform_fromRobot("I started \"thriller5\" because it was pending", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller5\" because it pended.",
                    operator_react("Why did you start \"thriller5\"?", semMem, lingDb));
    operator_inform_fromRobot("I started \"thriller6\" because an external program asked me that", semMem, lingDb);
    ONSEM_ANSWER_EQ("I started \"thriller6\" because an external program asked me that.",
                    operator_react("Why did you start \"thriller6\"?", semMem, lingDb));

    // stop activity reasons
    ONSEM_ANSWERNOTFOUND_EQ("I don't know why I stopped \"thriller\".",
                            operator_react("Why did you stop \"thriller\"?", semMem, lingDb));
    operator_inform_fromRobot("I stopped \"thriller\" because it exited by itself", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller\" because it exited by itself.",
                    operator_react("Why did you stop \"thriller\"?", semMem, lingDb));
    operator_inform_fromRobot(
        "I stopped \"thriller2\" because you stopped it by a head tactile gesture", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller2\" because you stopped that by a head tactile gesture.",
                    operator_react("Why did you stop \"thriller2\"?", semMem, lingDb));
    operator_inform_fromRobot("I stopped \"thriller3\" because no users were present", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller3\" because no user was present.",
                    operator_react("Why did you stop \"thriller3\"?", semMem, lingDb));
    operator_inform_fromRobot("I stopped \"thriller4\" because I stopped to live", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller4\" because I stopped to live.",
                    operator_react("Why did you stop \"thriller4\"?", semMem, lingDb));
    operator_inform_fromRobot("I stopped \"thriller5\" because I was injured", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller5\" because I was injured.",
                    operator_react("Why did you stop \"thriller5\"?", semMem, lingDb));
    operator_inform_fromRobot("I stopped \"thriller6\" because the context was incompatible", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller6\" because the context was incompatible.",
                    operator_react("Why did you stop \"thriller6\"?", semMem, lingDb));
    operator_inform_fromRobot(
        "I stopped \"thriller7\" because an external program started another activity", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller7\" because an external program started another activity.",
                    operator_react("Why did you stop \"thriller7\"?", semMem, lingDb));
    operator_inform_fromRobot(
        "I stopped \"thriller8\" because an external program stopped the application", semMem, lingDb);
    ONSEM_ANSWER_EQ("I stopped \"thriller8\" because an external program stopped the application.",
                    operator_react("Why did you stop \"thriller8\"?", semMem, lingDb));
    ...
    ONSEM_ANSWERNOTFOUND_EQ("I don't know how many humans I see.",
                            operator_react(howManyHumanDoYouSeeInEnglish, semMem, lingDb));
    ONSEM_ANSWERNOTFOUND_EQ("Je ne sais pas combien de gens il y a.",
                            operator_react("Combien il y a de gens ?", semMem, lingDb));
    ...
    semMem.memBloc.removeExpression(*seeSentence, lingDb, &axiomToConditionCurrentState);
    seeSentence =
        operator_informAxiom_fromRobot("There are 3 people. I see you and I see 2 other people.", semMem, lingDb);
