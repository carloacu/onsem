...
public:
    ...
    virtual std::list<UniqueSemanticExpression>& getSemExpThatCanBeAnswered() { return _semExpsThatCanBeAnswered; }
    virtual std::list<UniqueSemanticExpression>& getTriggers() { return _triggers; }
