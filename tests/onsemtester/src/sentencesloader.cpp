...
void SentencesLoader::loadFolder(const std::string& pFoldername) {
    loadFile(pFoldername + "/registration_corpus.xml");
}

void SentencesLoader::loadFile(const std::string& pFilename) {
...
void SentencesLoader::xLoadFile(const std::string& pFilename) {
...
void SentencesLoader::xLoadTxt(const std::string& pFilename) {
...
void SentencesLoader::xLoadXml(const std::string& pFilename) {
...
void SentencesLoader::getPrevSentence(std::string& pPrevString) {
...
void SentencesLoader::getCurrSentence(std::string& pNextString) const {
    pNextString = fResults->diffsInputSentences[fCurrIndex];
}

void SentencesLoader::getNextSentence(std::string& pNextString) {
    if (fResults->diffsInputSentences.empty()) {
        return;
    }
