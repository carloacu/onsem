...
void run(const std::string& pMyDataMiningPath,
    ...
    _run(lemmasToPos, pMyDataMiningPath + "/resources/french/verb_intransitifs/verb_intransitifs.txt", pLingDb);
    _run(lemmasToPos,
         pMyDataMiningPath
             + "/resources/french/verb_intransitifs/verb_transitifs_dont_ceux_qui_peuvent_etre_transitifs_aussi.txt",
         pLingDb);
