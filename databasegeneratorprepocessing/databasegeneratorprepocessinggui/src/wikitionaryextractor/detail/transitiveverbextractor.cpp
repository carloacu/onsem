...
WikiTransitiveVerbExtractor::WikiTransitiveVerbExtractor
...
void WikiTransitiveVerbExtractor::extract
      ...
      else
      {
        ...
        case PATTERNRECO_LANG_INLANG:
        {
          if (currWordInfos.wordNode == nullptr ||
              ...
              currWordInfos.partOfSpeeches.find(PartOfSpeech::VERB) == currWordInfos.partOfSpeeches.end())
          {
            break;
          }
...
void WikiTransitiveVerbExtractor::writeNewTransitiveVerbs
