...
namespace
{
void _list_words_by_pos_for_a_langauge_and_write_in_file
 ...
 SemanticLanguageEnum pLanguage)
{
  ...
  list_words_by_pos_for_a_langauge(pLingDbTree, pLanguage, [&](const std::string& pWord) {
    outFile << pWord << "\n";
  });
  outFile.close();
}
...
void list_words_by_pos_for_a_langauge
(const LingdbTree pLingDbTree,
 SemanticLanguageEnum pLanguage,
