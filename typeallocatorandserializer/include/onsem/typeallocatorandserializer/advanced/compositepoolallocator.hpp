...
public:
    ...
    void getComposites(std::vector<CompositePoolAllocator*>& pComposites);
     ...
     */
    template<typename T>
    void addANewLeaf(const std::string& pName, unsigned char pMemoryAlignment, get_pointers pFunc = nullptr);
