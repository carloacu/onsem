...
public:
     ...
     */
    template<typename T>
    void declareANewType(const std::string& pName, unsigned char pMemoryAlignment, get_pointers pFunc = nullptr);
 ...
 */
inline std::ostream& operator<<(std::ostream& pOs, const TypeAllocatorAndSerializer& pFPA) {
