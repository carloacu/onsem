...
template<typename T>
bool unordered_set_of_refs<T>::const_iterator::operator==(
    const typename unordered_set_of_refs<T>::const_iterator& pOther) const {
...
template<typename T>
bool unordered_set_of_refs<T>::const_iterator::operator==(
    const typename unordered_set_of_refs<T>::iterator& pOther) const {
    return _it == pOther._it;
}
...
template<typename T>
bool unordered_set_of_refs<T>::iterator::operator==(
    const typename unordered_set_of_refs<T>::const_iterator& pOther) const {
    return _it == pOther._it;
}
...
template<typename T>
typename unordered_set_of_refs<T>::iterator unordered_set_of_refs<T>::erase(
    const typename unordered_set_of_refs<T>::iterator& pIt) {
    return unordered_set_of_refs<T>::iterator(_elts.erase(pIt._it));
}

template<typename T>
typename unordered_set_of_refs<T>::iterator unordered_set_of_refs<T>::erase(
    const typename unordered_set_of_refs<T>::const_iterator& pIt) {
    return unordered_set_of_refs<T>::iterator(_elts.erase(pIt._it));
}
...
typename unordered_set_of_refs<T>::const_iterator unordered_set_of_refs<T>::find(const T& pElt) const {
    return unordered_set_of_refs<T>::const_iterator(
