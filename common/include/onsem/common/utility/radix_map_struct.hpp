...
template<typename KEY_TYPE, typename VALUE_TYPE>
template<typename... Args>
void radix_map_struct<KEY_TYPE, VALUE_TYPE>::emplace(const KEY_TYPE& pKey,
                                                     Args&&... pArgs)
{
...
template<typename KEY_TYPE, typename VALUE_TYPE>
std::pair<typename radix_map<char, std::string, VALUE_TYPE>::iterator, bool> radix_map_struct<KEY_TYPE, VALUE_TYPE>::insert(
    const KEY_TYPE& pKey)
{
...
template<typename KEY_TYPE, typename VALUE_TYPE>
VALUE_TYPE* radix_map_struct<KEY_TYPE, VALUE_TYPE>::find_ptr(
    const KEY_TYPE& pKey)
{
...
template<typename KEY_TYPE, typename VALUE_TYPE>
const VALUE_TYPE* radix_map_struct<KEY_TYPE, VALUE_TYPE>::find_ptr(
    const KEY_TYPE& pKey) const
{
  return radix_map_str<VALUE_TYPE>::find_ptr(pKey.toRadixMapStr());
}
