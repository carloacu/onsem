...
enum class InformationType { ONSEM_SEMANTIC_INFORMATIONTYPE_TABLE };
#undef ADD_ONSEM_SEMANTIC_INFORMATIONTYPE

#define ADD_ONSEM_SEMANTIC_INFORMATIONTYPE(a, b) {InformationType::a, b},
static const std::map<InformationType, std::string> _informationType_toStr = {ONSEM_SEMANTIC_INFORMATIONTYPE_TABLE};
#undef ADD_ONSEM_SEMANTIC_INFORMATIONTYPE

#define ADD_ONSEM_SEMANTIC_INFORMATIONTYPE(a, b) {b, InformationType::a},
static const std::map<std::string, InformationType> _informationType_fromStr = {ONSEM_SEMANTIC_INFORMATIONTYPE_TABLE};
#undef ADD_ONSEM_SEMANTIC_INFORMATIONTYPE
#undef ONSEM_SEMANTIC_INFORMATIONTYPE_TABLE

static inline std::string informationType_toStr(InformationType pInformationType) {
    return _informationType_toStr.find(pInformationType)->second;
}

static inline InformationType informationType_fromStr(const std::string& pInformationTypeStr) {
