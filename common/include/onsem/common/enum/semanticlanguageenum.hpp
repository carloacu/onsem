...
enum class SemanticLanguageEnum : char { MIND_SEMANTIC_LANGUAGEGROUNDINGS_TABLE };
#undef ADD_MIND_SEMANTIC_LANGUAGEGROUNDINGS

#define ADD_MIND_SEMANTIC_LANGUAGEGROUNDINGS(a, b, c, d, e) b,
static const std::vector<std::string> _semanticLanguageEnum_toLegacyStr = {MIND_SEMANTIC_LANGUAGEGROUNDINGS_TABLE};
#undef ADD_MIND_SEMANTIC_LANGUAGEGROUNDINGS
...
static const std::vector<std::string> _semanticLanguageEnum_toStr = {MIND_SEMANTIC_LANGUAGEGROUNDINGS_TABLE};
#undef ADD_MIND_SEMANTIC_LANGUAGEGROUNDINGS
...
static const std::size_t semanticLanguageEnum_size = MIND_SEMANTIC_LANGUAGEGROUNDINGS_TABLE 0;
#undef ADD_MIND_SEMANTIC_LANGUAGEGROUNDINGS
...
static inline std::string semanticLanguageEnum_toStr(SemanticLanguageEnum pLangueType) {
    return _semanticLanguageEnum_toStr[semanticLanguageEnum_toChar(pLangueType)];
}

static inline std::string semanticLanguageEnum_toLegacyStr(SemanticLanguageEnum pLangueType) {
    return _semanticLanguageEnum_toLegacyStr[semanticLanguageEnum_toChar(pLangueType)];
}

static inline std::string semanticLanguageEnum_toLanguageFilenameStr(SemanticLanguageEnum pLangueType) {
    return _semanticLanguageEnum_toLanguageFilenameStr[semanticLanguageEnum_toChar(pLangueType)];
}

static inline SemanticLanguageEnum semanticLanguageEnum_fromStr(const std::string& pLangueStr) {
...
static inline SemanticLanguageEnum semanticLanguageEnum_fromLanguageFilenameStr(const std::string& pLangueStr) {
...
static inline mystd::optional<SemanticLanguageEnum> semanticLanguageEnum_fromStrOpt(const std::string& pLangueStr) {
...
static inline bool semanticLanguageEnum_fromStrIfExist(SemanticLanguageEnum& pRes, const std::string& pLangueStr) {
    auto it = _semanticLanguageEnum_fromStr.find(pLangueStr);
    if (it != _semanticLanguageEnum_fromStr.end()) {
        pRes = it->second;
        return true;
...
static inline bool semanticLanguageEnum_fromLegacyStrIfExist(SemanticLanguageEnum& pRes,
...
static inline bool semanticLanguageEnum_fromTtsStrIfExist(SemanticLanguageEnum& pRes, const std::string& pLangueStr) {
...
static inline std::string sayLanguageInLanguage(SemanticLanguageEnum pLanguageConvertInText,
...
static inline SemanticLanguageEnum semanticLanguageTypeGroundingEnumFromStr(const std::string& pStr) {
    SemanticLanguageEnum res = SemanticLanguageEnum::UNKNOWN;
    if (semanticLanguageEnum_fromStrIfExist(res, pStr) || semanticLanguageEnum_fromLegacyStrIfExist(res, pStr)
