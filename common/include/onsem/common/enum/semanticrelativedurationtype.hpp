...
#define SEMANTIC_RELATIVEDURATIONTYPE_TABLE ADD_SEMANTIC_RELATIVEDURATIONTYPE(UNTIL, "until")

#define ADD_SEMANTIC_RELATIVEDURATIONTYPE(a, b) a,
enum class SemanticRelativeDurationType : char { SEMANTIC_RELATIVEDURATIONTYPE_TABLE };
#undef ADD_SEMANTIC_RELATIVEDURATIONTYPE

#define ADD_SEMANTIC_RELATIVEDURATIONTYPE(a, b) b,
static const std::vector<std::string> _semanticRelativeDurationType_toStr = {SEMANTIC_RELATIVEDURATIONTYPE_TABLE};
#undef ADD_SEMANTIC_RELATIVEDURATIONTYPE
...
static inline bool semanticRelativeDurationType_fromStr_ifFound(SemanticRelativeDurationType& pRelativeDuration,
                                                                const std::string& pRelDurationTypeStr) {
    auto itOfConvertion = _semanticRelativeDurationType_fromStr.find(pRelDurationTypeStr);
    if (itOfConvertion != _semanticRelativeDurationType_fromStr.end()) {
