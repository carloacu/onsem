...
enum class SemanticSubjectiveQuantity : char
{
...
static const std::vector<std::string> _semanticSubjectiveQuantity_toStr = {
  SEMANTIC_SUBJECTIVEQUANTITY_TABLE
};
#undef ADD_SEMANTIC_SUBJECTIVEQUANTITY
...
static inline std::string semanticSubjectiveQuantity_toStr
(SemanticSubjectiveQuantity pSubjectiveQuantity)
{
  return _semanticSubjectiveQuantity_toStr[semanticSubjectiveQuantity_toChar(pSubjectiveQuantity)];
}


static inline SemanticSubjectiveQuantity semanticSubjectiveQuantity_fromStr
(const std::string& pSubjectiveQuantityStr)
{
