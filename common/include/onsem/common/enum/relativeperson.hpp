...
enum class RelativePerson {
  SEMANTIC_REATIVEPERSON_TYPE_TABLE
};
...
static const std::map<RelativePerson, std::string> _relativePerson_toStr = {
  SEMANTIC_REATIVEPERSON_TYPE_TABLE
};
#undef ADD_SEMANTIC_REATIVEPERSON_TYPE

#define ADD_SEMANTIC_REATIVEPERSON_TYPE(a, b) {b, RelativePerson::a},
static const std::map<std::string, RelativePerson> _relativePerson_fromStr = {
  SEMANTIC_REATIVEPERSON_TYPE_TABLE
};
#undef ADD_SEMANTIC_REATIVEPERSON_TYPE
...
static inline SemanticNumberType relativePerson_toNumberType
...
static inline std::string relativePerson_toStr
(RelativePerson pRelPerson)
{
...
static inline RelativePerson relativePerson_fromStr
...
static inline bool relativePersonsAreWeaklyEqual(RelativePerson pRelPerson1,
                                                 RelativePerson pRelPerson2)
{
   return pRelPerson1 == pRelPerson2 ||
      pRelPerson1 == RelativePerson::UNKNOWN ||
...
static inline void relativePerson_toConcisePrintWithoutNumber
(std::ostream& pOs,
 RelativePerson pRelPerson)
{
  switch (pRelPerson)
