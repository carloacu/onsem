...
enum class ListExpressionType : char
{
  ADD_SEMANTIC_LISTEXPTYPE_TABLE
};
#undef ADD_SEMANTIC_LISTEXPTYPE


#define ADD_SEMANTIC_LISTEXPTYPE(a, b) b,
static const std::vector<std::string> _listExpressionType_toStr = {
  ADD_SEMANTIC_LISTEXPTYPE_TABLE
};
#undef ADD_SEMANTIC_LISTEXPTYPE

#define ADD_SEMANTIC_LISTEXPTYPE(a, b) {b, ListExpressionType::a},
static const std::map<std::string, ListExpressionType> _listExpressionType_fromStr = {
  ADD_SEMANTIC_LISTEXPTYPE_TABLE
};
#undef ADD_SEMANTIC_LISTEXPTYPE
...
static inline ListExpressionType listExpressionType_fromStr
(const std::string& pListExpTypeStr)
{
