...
enum class SemanticQuantityType : char
{
  SEMANTIC_QUANTITY_TABLE
};
#undef ADD_SEMANTIC_QUANTITY


#define ADD_SEMANTIC_QUANTITY(a, b) b,
static const std::vector<std::string> _semanticQuantityType_toStr = {
  SEMANTIC_QUANTITY_TABLE
};
#undef ADD_SEMANTIC_QUANTITY

#define ADD_SEMANTIC_QUANTITY(a, b) {b, SemanticQuantityType::a},
static const std::map<std::string, SemanticQuantityType> _semanticQuantityType_fromStr = {
  SEMANTIC_QUANTITY_TABLE
};
#undef ADD_SEMANTIC_QUANTITY
...
static inline std::string semanticQuantityType_toStr
...
static inline SemanticQuantityType semanticQuantityType_fromStr
(const std::string& pQuantityTypeStr)
{
