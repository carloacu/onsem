...
enum class GrammaticalType : char { SEMANTIC_GRAMMATICALTYPE_TABLE };
#undef SEMANTIC_GRAMMATICALTYPE

#define SEMANTIC_GRAMMATICALTYPE(a, b) b,
static const std::vector<std::string> _grammaticalType_toStr = {SEMANTIC_GRAMMATICALTYPE_TABLE};
#undef SEMANTIC_GRAMMATICALTYPE

#define SEMANTIC_GRAMMATICALTYPE(a, b) {b, GrammaticalType::a},
static const std::map<std::string, GrammaticalType> _grammaticalType_fromStr = {SEMANTIC_GRAMMATICALTYPE_TABLE};
#undef SEMANTIC_GRAMMATICALTYPE

#define SEMANTIC_GRAMMATICALTYPE(a, b) GrammaticalType::a,
static const std::vector<GrammaticalType> grammaticalType_allValues = {SEMANTIC_GRAMMATICALTYPE_TABLE};
#undef SEMANTIC_GRAMMATICALTYPE

#define SEMANTIC_GRAMMATICALTYPE(a, b) 1 +
static const std::size_t grammaticalType_size = SEMANTIC_GRAMMATICALTYPE_TABLE 0;
#undef SEMANTIC_GRAMMATICALTYPE
...
static inline GrammaticalType grammaticalType_fromStr(const std::string& pGramTypeStr) {
