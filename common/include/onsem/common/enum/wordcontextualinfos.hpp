...
enum class WordContextualInfos : char { WORDCONTEXTUALINFOS_TYPE_TABLE };
#undef ADD_WORDCONTEXTUALINFOS_TYPE

#define ADD_WORDCONTEXTUALINFOS_TYPE(a, b) {b, WordContextualInfos::a},
static const std::map<std::string, WordContextualInfos> _wordContextualInfos_fromStr = {WORDCONTEXTUALINFOS_TYPE_TABLE};
#undef ADD_WORDCONTEXTUALINFOS_TYPE

#define ADD_WORDCONTEXTUALINFOS_TYPE(a, b) {WordContextualInfos::a, b},
static const std::map<WordContextualInfos, std::string> _wordContextualInfos_toStr = {WORDCONTEXTUALINFOS_TYPE_TABLE};
#undef ADD_WORDCONTEXTUALINFOS_TYPE

static inline std::string wordContextualInfos_toStr(WordContextualInfos pWordContextualInfos) {
    return _wordContextualInfos_toStr.find(pWordContextualInfos)->second;
}

inline static WordContextualInfos wordContextualInfos_fromStr(const std::string& pStr) {
