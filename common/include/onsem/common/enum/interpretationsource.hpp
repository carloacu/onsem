...
enum class InterpretationSource : char { SEMANTIC_INTERPREATIONFROM_TABLE };
...
#define ADD_SEMANTIC_INTERPREATIONFROM(a, b) b,
    static const std::vector<std::string> _interpretationFrom_toStr = {SEMANTIC_INTERPREATIONFROM_TABLE};
#undef ADD_SEMANTIC_INTERPREATIONFROM
