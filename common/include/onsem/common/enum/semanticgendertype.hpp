...
enum class SemanticGenderType : char
{
  SEMANTIC_GENDER_TYPE_TABLE
};
...
static const std::vector<std::string> _semanticGenderType_toStr = {
  SEMANTIC_GENDER_TYPE_TABLE
};
#undef ADD_SEMANTIC_GENDER_TYPE

#define ADD_SEMANTIC_GENDER_TYPE(a, b) {b, SemanticGenderType::a},
static const std::map<std::string, SemanticGenderType> _semanticGenderType_fromStr = {
  SEMANTIC_GENDER_TYPE_TABLE
};
#undef ADD_SEMANTIC_GENDER_TYPE
...
static inline std::string semanticGenderType_toStr
(SemanticGenderType pGenderType)
{
  return _semanticGenderType_toStr[semanticGenderType_toChar(pGenderType)];
}


static inline SemanticGenderType semanticGenderType_fromStr
(const std::string& pGenderTypeStr)
{
...
static inline bool gendersAreWeaklyEqual(SemanticGenderType pGender1,
                                         SemanticGenderType pGender2)
{
  return pGender1 == pGender2 ||
      pGender1 == SemanticGenderType::UNKNOWN ||
      pGender2 == SemanticGenderType::UNKNOWN;
}


static inline void gender_toConcisePrint
(std::ostream& pOs,
...
static inline bool gender_fromConcisePrint
(SemanticGenderType& pGender,
 char pChar)
{
  switch (pChar)
