...
static const std::vector<std::string> _ComparisonOperator_toStr = {
  SEMANTIC_COMPARISONOPERATOR_TABLE
};
#undef SEMANTIC_COMPARISONOPERATOR
...
static inline ComparisonOperator ComparisonOperator_fromStr
(const std::string& pComparisonOperatorStr)
{
