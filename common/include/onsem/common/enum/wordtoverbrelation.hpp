...
enum class WordToVerbRelation : char { WORDTOVERBRELLATION_TABLE };
#undef WORDTOVERBRELLATION_ENUMVAL

#define WORDTOVERBRELLATION_ENUMVAL(a, b) {b, WordToVerbRelation::a},
static const std::map<std::string, WordToVerbRelation> _wordToVerbRelations_fromStr = {WORDTOVERBRELLATION_TABLE};
#undef WORDTOVERBRELLATION_ENUMVAL

inline static WordToVerbRelation wordToVerbRelations_fromStr(const std::string& pStr) {
