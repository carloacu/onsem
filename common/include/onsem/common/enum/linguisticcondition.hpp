...
enum class LinguisticCondition { ONSEM_LINGUISTICCONDITION_TABLE };
#undef ADD_LINGUISTICCONDITION

#define ADD_LINGUISTICCONDITION(a, b) {LinguisticCondition::a, b},
static const std::map<LinguisticCondition, std::string> _linguisticCondition_toStr = {ONSEM_LINGUISTICCONDITION_TABLE};
#undef ADD_LINGUISTICCONDITION
...
static inline bool linguisticCondition_fromStr(LinguisticCondition& pCondition, const std::string& pStr) {
