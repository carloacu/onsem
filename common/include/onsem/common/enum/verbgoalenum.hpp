...
enum class VerbGoalEnum : char
{
  SEMANTIC_VERBGOAL_TABLE
};
...
static const std::vector<std::string> _alSemVerbGoalEnum_toStr = {
  SEMANTIC_VERBGOAL_TABLE
};
#undef ADD_SEMANTIC_VERBGOAL
...
static const std::map<std::string, VerbGoalEnum> _alSemVerbGoalEnum_fromStr = {
  SEMANTIC_VERBGOAL_TABLE
};
#undef ADD_SEMANTIC_VERBGOAL
...
static inline VerbGoalEnum semVerbGoalEnum_fromStr
(const std::string& pVerbGoalStr)
{
