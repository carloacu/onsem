...
enum class SemanticVerbTense : char
{
  SEMANTIC_VERBTENSE_TABLE
};
...
static const std::vector<std::string> _semanticVerbTense_toStr = {
  SEMANTIC_VERBTENSE_TABLE
};
#undef ADD_SEMANTIC_VERBTENSE

#define ADD_SEMANTIC_VERBTENSE(a, b) {b, SemanticVerbTense::a},
static const std::map<std::string, SemanticVerbTense> _semanticVerbTense_fromStr = {
  SEMANTIC_VERBTENSE_TABLE
};
#undef ADD_SEMANTIC_VERBTENSE
...
static inline SemanticVerbTense semanticVerbTense_fromStr
...
{
  return pVerbTense == SemanticVerbTense::PUNCTUALPAST ||
      pVerbTense == SemanticVerbTense::PAST;
}

static inline bool isAPresentTense(SemanticVerbTense pVerbTense)
{
  return pVerbTense == SemanticVerbTense::PUNCTUALPRESENT ||
