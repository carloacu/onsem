...
enum class LinkedMeaningDirection {
...
static inline std::string linkedMeaningDirection_toStr
(LinkedMeaningDirection pLinkedMeaningDirection)
{
  return _linkedMeaningDirection_toStr.find(pLinkedMeaningDirection)->second;
}

static inline LinkedMeaningDirection linkedMeaningDirection_fromStr
(const std::string& pLinkedMeaningDirectionStr)
{
