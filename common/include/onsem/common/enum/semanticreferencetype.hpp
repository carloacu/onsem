...
enum class SemanticReferenceType : char
{
...
static const std::vector<std::string> _semanticReferenceType_toStr = {
  SEMANTIC_GENERIC_REFERENCE_TABLE
};
#undef ADD_SEMANTIC_REFERENCE_TYPE
...
static inline std::string semanticReferenceType_toStr
...
static inline SemanticReferenceType semanticReferenceType_fromStr
(const std::string& pReferenceTypeStr)
{
