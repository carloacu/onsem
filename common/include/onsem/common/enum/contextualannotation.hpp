...
enum class ContextualAnnotation : char
{
...
static const std::vector<std::string> _contextualAnnotation_toStr = {
  ONSEM_SEMANTIC_CONTEXTUALANNOTATION_TABLE
};
#undef ADD_ONSEM_SEMANTIC_CONTEXTUALANNOTATION
...
static inline std::string contextualAnnotation_toStr
...
static inline ContextualAnnotation contextualAnnotation_fromStr
(const std::string& pContextualAnnotationStr)
{
