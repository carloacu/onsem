...
enum class SemanticSourceEnum : char { ONSEM_SEMANTIC_SOURCEENUM_TABLE };
#undef ADD_ONSEM_SEMANTIC_SOURCEENUM

#define ADD_ONSEM_SEMANTIC_SOURCEENUM(a, b) b,
static const std::vector<std::string> _semanticSourceEnum_toStr = {ONSEM_SEMANTIC_SOURCEENUM_TABLE};
#undef ADD_ONSEM_SEMANTIC_SOURCEENUM

#define ADD_ONSEM_SEMANTIC_SOURCEENUM(a, b) {b, SemanticSourceEnum::a},
static const std::map<std::string, SemanticSourceEnum> _semanticSourceEnum_fromStr = {ONSEM_SEMANTIC_SOURCEENUM_TABLE};
#undef ADD_ONSEM_SEMANTIC_SOURCEENUM
...
static inline SemanticSourceEnum semanticSourceEnum_fromStr(const std::string& pSourceTypeStr) {
