...
enum TreePatternConventionEnum { TREEPATTERN_ENUM_TABLE TREEPATTERN_ENUM_TABLE_ENDFORNOCOMPILWARNING };
#undef ADD_TREEPATTERN_ENUMVAL

#define ADD_TREEPATTERN_ENUMVAL(a, b) b,
static const std::string treePatternConventionEnum_toStr[] = {TREEPATTERN_ENUM_TABLE};
#undef ADD_TREEPATTERN_ENUMVAL

static inline TreePatternConventionEnum treePatternConventionEnum_fromStr(const std::string& pValStr) {
    for (std::size_t i = 0; i < TREEPATTERN_ENUM_TABLE_ENDFORNOCOMPILWARNING; ++i) {
