...
enum class RelativePersonWithoutNumber { SEMANTIC_REATIVEPERSONWITHOUTNUMBER_TYPE_TABLE };
...
static inline std::string relativePersonWithoutNumber_toStr(RelativePersonWithoutNumber pRelPerson) {
    return _relativePersonWithoutNumber_toStr.find(pRelPerson)->second;
}

static inline RelativePersonWithoutNumber relativePersonWithoutNumber_fromStr(const std::string& pRelPersonStr) {
...
static inline void relativePersonWithoutNumber_toConcisePrint(std::ostream& pOs,
                                                              RelativePersonWithoutNumber pRelPerson) {
    switch (pRelPerson) {
        case RelativePersonWithoutNumber::FIRST: pOs << '1'; return;
        case RelativePersonWithoutNumber::SECOND: pOs << '2'; return;
        case RelativePersonWithoutNumber::THIRD: pOs << '3'; return;
        case RelativePersonWithoutNumber::UNKNOWN: return;
    }
}

static inline bool relativePersonWithoutNumber_fromConcisePrint(RelativePersonWithoutNumber& pRelPerson, char pChar) {
    switch (pChar) {
        case '1': pRelPerson = RelativePersonWithoutNumber::FIRST; return true;
        case '2': pRelPerson = RelativePersonWithoutNumber::SECOND; return true;
        case '3': pRelPerson = RelativePersonWithoutNumber::THIRD; return true;
