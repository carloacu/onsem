...
enum class SemanticRelativeTimeType : char { SEMANTIC_RELATIVETIMETYPE_TABLE };
#undef ADD_SEMANTIC_RELATIVETIMETYPE

#define ADD_SEMANTIC_RELATIVETIMETYPE(a, b) b,
static const std::vector<std::string> _semanticRelativeTimeType_toStr = {SEMANTIC_RELATIVETIMETYPE_TABLE};
#undef ADD_SEMANTIC_RELATIVETIMETYPE
...
static const std::size_t semanticRelativeTimeType_size = SEMANTIC_RELATIVETIMETYPE_TABLE 0;
#undef ADD_SEMANTIC_RELATIVETIMETYPE
...
static inline SemanticRelativeTimeType semanticRelativeTimeType_fromStr(const std::string& pRelTimeTypeStr) {
...
static inline bool semanticRelativeTimeType_fromStr_ifFound(SemanticRelativeTimeType& pRelativeTime,
