...
enum class LinguisticVerbTense { SEMANTIC_LINGUISTICVERBTENSE_TABLE };
...
static const std::map<LinguisticVerbTense, char> _linguisticVerbTense_toChar = {SEMANTIC_LINGUISTICVERBTENSE_TABLE};
#undef ADD_SEMANTIC_LINGUISTICVERBTENSE

#define ADD_SEMANTIC_LINGUISTICVERBTENSE(a, b, c) {c, LinguisticVerbTense::a},
static const std::map<char, LinguisticVerbTense> _linguisticVerbTense_fromChar = {SEMANTIC_LINGUISTICVERBTENSE_TABLE};
#undef ADD_SEMANTIC_LINGUISTICVERBTENSE

static inline std::string linguisticVerbTense_toStr(LinguisticVerbTense pVerbTense) {
    return _linguisticVerbTense_toStr.find(pVerbTense)->second;
}

static inline LinguisticVerbTense linguisticVerbTense_fromStr(const std::string& pVerbTenseStr) {
...
static inline char linguisticVerbTense_toChar(LinguisticVerbTense pVerbTense) {
    return _linguisticVerbTense_toChar.find(pVerbTense)->second;
}

static inline LinguisticVerbTense linguisticVerbTense_fromChar(char pChar) {
