...
{
  PARTOFSPEECH_TYPE_TABLE
};
#undef ADD_PARTOFSPEECH_TYPE


#define ADD_PARTOFSPEECH_TYPE(a, b, c) {b, PartOfSpeech::a},
static const std::map<std::string, PartOfSpeech> _partOfSpeech_fromStr = {
  PARTOFSPEECH_TYPE_TABLE
};
#undef ADD_PARTOFSPEECH_TYPE

#define ADD_PARTOFSPEECH_TYPE(a, b, c) b,
static const std::vector<std::string> _partOfSpeech_toStr = {
  PARTOFSPEECH_TYPE_TABLE
};
#undef ADD_PARTOFSPEECH_TYPE

#define ADD_PARTOFSPEECH_TYPE(a, b, c) c,
static const std::vector<std::string> _partOfSpeech_toCptName = {
  PARTOFSPEECH_TYPE_TABLE
};
#undef ADD_PARTOFSPEECH_TYPE
...
{
  return pPartOfSpeech == PartOfSpeech::VERB ||
      pPartOfSpeech == PartOfSpeech::AUX;
}


static inline bool partOfSpeech_isNominal(PartOfSpeech pPartOfSpeech)
{
  return pPartOfSpeech == PartOfSpeech::NOUN ||
      pPartOfSpeech == PartOfSpeech::PROPER_NOUN ||
...
{
  return pPartOfSpeech == PartOfSpeech::PRONOUN ||
      pPartOfSpeech == PartOfSpeech::PRONOUN_COMPLEMENT ||
