...
{
  SEMANTIC_COMPARISONTYPE_TABLE
};
#undef SEMANTIC_COMPARISONTYPE


#define SEMANTIC_COMPARISONTYPE(a, b) {ComparisonType::a, b},
static const std::map<ComparisonType, std::string> _comparisonType_toStr = {
  SEMANTIC_COMPARISONTYPE_TABLE
};
#undef SEMANTIC_COMPARISONTYPE

#define SEMANTIC_COMPARISONTYPE(a, b) {b, ComparisonType::a},
static const std::map<std::string, ComparisonType> _comparisonType_fromStr = {
  SEMANTIC_COMPARISONTYPE_TABLE
};
#undef SEMANTIC_COMPARISONTYPE
...
static inline std::string comparisonType_toStr
...
static inline ComparisonType comparisonType_fromStr
(const std::string& pComparisonTypeStr)
{
...
static inline void comparisonType_toConcisePrint
(std::ostream& pOs,
 ComparisonType pComparisonType)
{
  switch (pComparisonType)
  {
  case ComparisonType::COMPARATIVE:
    pOs << 'C';
    return;
  case ComparisonType::SUPERLATIVE:
    pOs << 'S';
    return;
...
static inline bool comparisonType_fromConcisePrint
(ComparisonType& pComparisonType,
 char pChar)
{
  switch (pChar)
  {
  case 'C':
    pComparisonType = ComparisonType::COMPARATIVE;
    return true;
  case 'S':
    pComparisonType = ComparisonType::SUPERLATIVE;
    return true;
  default:
    return false;
  }
