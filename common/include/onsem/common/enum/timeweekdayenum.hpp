...
enum class TimeWeekdayEnum { SEMANTICTIME_WEEKDAY_TABLE };
#undef ADD_SEMANTICTIME_WEEKDAY_TYPE

#define ADD_SEMANTICTIME_WEEKDAY_TYPE(a, b) {TimeWeekdayEnum::a, b},
static const std::map<TimeWeekdayEnum, std::string> _semanticTimeWeekdayEnum_toStr = {SEMANTICTIME_WEEKDAY_TABLE};
#undef ADD_SEMANTICTIME_WEEKDAY_TYPE

#define ADD_SEMANTICTIME_WEEKDAY_TYPE(a, b) {b, TimeWeekdayEnum::a},
static const std::map<std::string, TimeWeekdayEnum> _semanticTimeWeekdayEnum_fromStr = {SEMANTICTIME_WEEKDAY_TABLE};
#undef ADD_SEMANTICTIME_WEEKDAY_TYPE

static inline TimeWeekdayEnum getNextWeekDay(TimeWeekdayEnum pWeekDay) {
...
static inline TimeWeekdayEnum getPrevWeekDay(TimeWeekdayEnum pWeekDay) {
...
static inline std::string semanticTimeWeekdayEnum_toStr(TimeWeekdayEnum pWeekDay) {
    return _semanticTimeWeekdayEnum_toStr.find(pWeekDay)->second;
}

static inline TimeWeekdayEnum semanticTimeWeekdayEnum_fromStr(const std::string& pWeekDayStr) {
