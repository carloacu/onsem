...
struct ONSEM_COMMON_API KeyToFStreams {
    ...
    void addMainDicFile(SemanticLanguageEnum pLanguage, const std::string& pFilename);
    void addSynthesizerFile(SemanticLanguageEnum pLanguage, const std::string& pFilename);
    void addFile(SemanticLanguageEnum pInLanguage, SemanticLanguageEnum pOutLanguage, const std::string& pFilename);
    void addConceptFile(const std::string& pFilename);
    void addDynamicContentFile(const std::string& pFilename);
    void addConversionFile(SemanticLanguageEnum pLanguage, const std::string& pLocalPath, const std::string& pFilename);
    void close();
