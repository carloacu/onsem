...
inline static const unsigned char* readEnumMapFull
...
inline static const unsigned char* readEnumMap
(const unsigned char* pPtr,
 unsigned char pKey,
 std::size_t pNbOfEnumValues)
{
...
(const unsigned char* pPtr,
 ...
 const std::function<void(unsigned char,
                          const unsigned char*)>& pOnEachElements)
{
...
inline static const unsigned char* readIntMap
(const unsigned char* pPtr,
 int pKey)
{
  auto* beginPtr = pPtr;
...
inline static void readAllIntMapValues
(const unsigned char* pPtr,
