...
void KeyToFStreams::addMainDicFile(SemanticLanguageEnum pLanguage,
...
void KeyToFStreams::addSynthesizerFile(SemanticLanguageEnum pLanguage,
                                       const std::string& pFilename)
{
...
std::ifstream& KeyToFStreams::_addKeyToIfStreamFile(
