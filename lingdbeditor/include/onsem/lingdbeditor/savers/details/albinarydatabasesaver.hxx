#ifndef BINARYDATABASESAVER_HXX
#define BINARYDATABASESAVER_HXX
...
template<typename T>
binarymasks::Ptr ALBinaryDatabaseSaver::xCreateRootNode
...
template<typename T>
binarymasks::Ptr ALBinaryDatabaseSaver::xIterateOnChildren
(T& pTreeCreationWorkState,
 int pParentPtr,
 ALLingdbDynamicTrieNode* pNode,
...
template<typename T>
binarymasks::Ptr ALBinaryDatabaseSaver::xAddANode
(T& pTreeCreationWorkState,
 int pParentPtr,
 ALLingdbDynamicTrieNode* pNode,
 const binarymasks::Ptr pBeginMemory,
