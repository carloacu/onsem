...
public:
    ...
    void getImperativeVerbForm(std::list<WordToSynthesize>& pVerbForm,
                               const StaticLinguisticMeaning& pMeaning,
                               RelativePerson pRelativePerson,
                               bool pIsPositiveForm) const;

    void getVerbForm(std::list<WordToSynthesize>& pVerbForm,
    ...
    void getAdjForm(std::string& pRes,
                    const StaticLinguisticMeaning& pMeaning,
                    SemanticGenderType pGender,
...
private:
     ...
     */
    StaticSynthesizerDictionary& operator=(const StaticSynthesizerDictionary& pDB);
