...
public:
    ...
    void addTemplateNameToChildSpecifications(const std::string& pTemplateName, ChildSpecification&& pChildSpec);
    void addWordToChildSpecifications(const SemanticWord& pWord, ChildSpecification&& pChildSpec);
    void addWordToTemplate(const SemanticWord& pWord, const std::string& pTemplateName);
    ...
    bool getIntroWordWithoutConditions(mystd::optional<SemanticWord>& pIntroWord, ChunkLinkType pChunkLinkType) const;
