...
public:
    ...
    int getTranslation(const std::string& pLemma, const StaticLinguisticMeaning& pInMeaning) const;
...
private:
    ...
    struct TranslationId {
        TranslationId(SemanticLanguageEnum pInLangEnum, SemanticLanguageEnum pOutLangEnum)
