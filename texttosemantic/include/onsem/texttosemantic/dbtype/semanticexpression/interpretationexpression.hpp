#ifndef ALSEMEXPDATABASES_INTERPRETATIONEXPRESSION_H
#define ALSEMEXPDATABASES_INTERPRETATIONEXPRESSION_H
...
template<typename TSEMEXP>
InterpretationExpression::InterpretationExpression
(InterpretationSource pSource,
 std::unique_ptr<TSEMEXP> pInterpretedExp,
 std::unique_ptr<TSEMEXP> pOriginalExp)
...
inline bool InterpretationExpression::isEqual(const InterpretationExpression& pOther) const
{
  return source == pOther.source &&
      interpretedExp == pOther.interpretedExp &&
      originalExp == pOther.originalExp;
}


} // End of namespace onsem

#endif // ALSEMEXPDATABASES_INTERPRETATIONEXPRESSION_H
