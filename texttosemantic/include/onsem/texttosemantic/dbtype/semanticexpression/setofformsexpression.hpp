#ifndef ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICEXPRESSION_SETOFFORMSEXPRESSION_HPP
#define ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICEXPRESSION_SETOFFORMSEXPRESSION_HPP
...
struct ONSEM_TEXTTOSEMANTIC_API QuestExpressionFrom {
    QuestExpressionFrom(UniqueSemanticExpression&& pUSemExp, bool pIsOriginalForm);

    template<typename TSEMEXP>
    QuestExpressionFrom(std::unique_ptr<TSEMEXP> pUSemExp, bool pIsOriginalForm);
...
template<typename TSEMEXP>
QuestExpressionFrom::QuestExpressionFrom(std::unique_ptr<TSEMEXP> pUSemExp, bool pIsOriginalForm)
...
#endif    // ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICEXPRESSION_SETOFFORMSEXPRESSION_HPP
