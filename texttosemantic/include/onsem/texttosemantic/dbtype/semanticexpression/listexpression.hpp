#ifndef ALSEMEXPDATABASES_LISTEXPRESSION_H
#define ALSEMEXPDATABASES_LISTEXPRESSION_H
...
struct ONSEM_TEXTTOSEMANTIC_API ListExpression : public SemanticExpression
{
  ...
  bool isEqual(const ListExpression& pOther) const
  { return listType == pOther.listType && elts == pOther.elts; }
  void assertEltsEqual(const ListExpression& pOther) const;

  std::unique_ptr<ListExpression> clone(const IndexToSubNameToParameterValue* pParams = nullptr,
...
#endif // ALSEMEXPDATABASES_LISTEXPRESSION_H
