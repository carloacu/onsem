...
enum class CoreferenceDirectionEnum : char { ONSEM_SEMANTIC_COREFERENCEDIRECTION_TABLE };
#undef ADD_ONSEM_SEMANTIC_COREFERENCEDIRECTION

#define ADD_ONSEM_SEMANTIC_COREFERENCEDIRECTION(a, b) b,
static const std::vector<std::string> _coreferenceDirectionEnum_toStr = {ONSEM_SEMANTIC_COREFERENCEDIRECTION_TABLE};
#undef ADD_ONSEM_SEMANTIC_COREFERENCEDIRECTION
...
static inline std::string coreferenceDirectionEnum_toStr(CoreferenceDirectionEnum pCoreference) {
    return _coreferenceDirectionEnum_toStr[coreferenceDirectionEnum_toChar(pCoreference)];
}

static inline CoreferenceDirectionEnum coreferenceDirectionEnum_fromStr(const std::string& pCoreferenceStr) {
...
struct Coreference {
    ...
    bool operator==(const Coreference& pOther) const { return _direction == pOther._direction; }
