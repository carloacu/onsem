...
{
  LINGUISTIC_INFLECTIONTYPE_TABLE
};
...
static const std::map<InflectionType, std::string> _inflectionType_toStr = {
  LINGUISTIC_INFLECTIONTYPE_TABLE
};
#undef ADD_LINGUISTIC_INFLECTIONTYPE

#define ADD_LINGUISTIC_INFLECTIONTYPE(a, b) {b, InflectionType::a},
static const std::map<std::string, InflectionType> _inflectionType_fromStr = {
  LINGUISTIC_INFLECTIONTYPE_TABLE
};
#undef ADD_LINGUISTIC_INFLECTIONTYPE


static inline std::string inflectionType_toStr
(InflectionType pVerbTense)
{
  return _inflectionType_toStr.find(pVerbTense)->second;
}


static inline InflectionType inflectionType_fromStr
...
static inline InflectionType inflectionType_fromPartOfSpeech
(PartOfSpeech pPartOfSpeech)
{
  switch (pPartOfSpeech)
  {
  case PartOfSpeech::ADJECTIVE:
    return InflectionType::ADJECTIVAL;
  case PartOfSpeech::NOUN:
  case PartOfSpeech::PROPER_NOUN:
  case PartOfSpeech::DETERMINER:
  case PartOfSpeech::PARTITIVE:
  case PartOfSpeech::PREPOSITION:
    return InflectionType::NOMINAL;
  case PartOfSpeech::VERB:
  case PartOfSpeech::AUX:
    return InflectionType::VERBAL;
