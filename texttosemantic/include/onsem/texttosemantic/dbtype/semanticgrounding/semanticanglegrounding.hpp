...
enum class SemanticAngleUnity : char { SEMANTIC_ANGLE_UNITY_TABLE };
#undef SEMANTIC_ANGLE_UNITY

#define SEMANTIC_ANGLE_UNITY(a, b, c) b,
static const std::vector<std::string> _semanticAngleUnity_toAbreviation = {SEMANTIC_ANGLE_UNITY_TABLE};
#undef SEMANTIC_ANGLE_UNITY

#define SEMANTIC_ANGLE_UNITY(a, b, c) c,
static const std::vector<std::string> _semanticAngleUnity_toStr = {SEMANTIC_ANGLE_UNITY_TABLE};
#undef SEMANTIC_ANGLE_UNITY
...
static const std::map<std::string, SemanticAngleUnity> _semanticAngleUnity_fromStr = {SEMANTIC_ANGLE_UNITY_TABLE};
#undef SEMANTIC_ANGLE_UNITY
...
static const std::vector<SemanticAngleUnity> semanticAngleUnities = {SEMANTIC_ANGLE_UNITY_TABLE};
#undef SEMANTIC_ANGLE_UNITY
...
static inline SemanticAngleUnity semanticAngleUnity_fromStr(const std::string& pAngleUnityStr) {
...
static inline SemanticAngleUnity semanticAngleUnity_fromAbreviation(const std::string& pAngleUnityStr) {
...
struct ONSEM_TEXTTOSEMANTIC_API SemanticAngle {
    ...
    void printAngle(std::list<std::string>& pListElts, const std::string& pLabelName) const;
...
inline bool SemanticAngleGrounding::isEqual(const SemanticAngleGrounding& pOther) const {
    return _isMotherClassEqual(pOther) && angle == pOther.angle;
}
