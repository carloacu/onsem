...
static const std::vector<std::string> _SemanticGroundingsType_toStr = {SEMANTIC_GROUNDING_TYPE_TABLE};
#undef SEMANTIC_GROUNGING_TYPE

#define SEMANTIC_GROUNGING_TYPE(a, b) {b, SemanticGroundingType::a},
static std::map<std::string, SemanticGroundingType> _SemanticGroundingsType_fromStr = {SEMANTIC_GROUNDING_TYPE_TABLE};
#undef SEMANTIC_GROUNGING_TYPE

#define SEMANTIC_GROUNGING_TYPE(a, b) SemanticGroundingType::a,
static const std::vector<SemanticGroundingType> semanticGroundingType_allValues = {SEMANTIC_GROUNDING_TYPE_TABLE};
#undef SEMANTIC_GROUNGING_TYPE

#define SEMANTIC_GROUNGING_TYPE(a, b) 1 +
static const std::size_t semanticGroundingType_size = SEMANTIC_GROUNDING_TYPE_TABLE 0;
#undef SEMANTIC_GROUNGING_TYPE
...
static inline SemanticGroundingType semanticGroundingsType_fromStr(const std::string& pGroundingStr) {
...
static inline bool semanticGroundingsType_fromStrIfExist(SemanticGroundingType& pRes,
...
static inline bool semanticGroundingsType_isRelativeType(SemanticGroundingType pRes) {
    return pRes == SemanticGroundingType::RELATIVETIME || pRes == SemanticGroundingType::RELATIVEDURATION
...
protected:
    SemanticGrounding(SemanticGroundingType pType)
        ...
        , polarity(true)
        , concepts() {}
    SemanticGrounding(SemanticGroundingType pType, const std::map<std::string, char>& pConcepts)
        : type(pType)
        , polarity(true)
        , concepts(pConcepts) {}
