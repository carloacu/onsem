#ifndef SEMANTICMODEL_TYPES_SEMANTICGROUNDING_SEMANTICRELATIVETIMEGROUNDING_HPP
#define SEMANTICMODEL_TYPES_SEMANTICGROUNDING_SEMANTICRELATIVETIMEGROUNDING_HPP
...
struct ONSEM_TEXTTOSEMANTIC_API SemanticRelativeTimeGrounding : public SemanticGrounding
{
  SemanticRelativeTimeGrounding(SemanticRelativeTimeType pTimeType)
    : SemanticGrounding(SemanticGroudingType::RELATIVETIME),
      timeType(pTimeType)
  {
  }
...
#endif // SEMANTICMODEL_TYPES_SEMANTICGROUNDING_SEMANTICRELATIVETIMEGROUNDING_HPP
