#ifndef ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICGROUNDING_SEMANTICDURATIONGROUNDING_HPP
#define ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICGROUNDING_SEMANTICDURATIONGROUNDING_HPP
...
enum class SemanticTimeUnity : char { SEMANTIC_TIME_UNITY_TABLE };
#undef SEMANTIC_TIME_UNITY

#define SEMANTIC_TIME_UNITY(a, b, c, d, e) b,
static const std::vector<std::string> _semanticTimeUnity_toStr = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY

#define SEMANTIC_TIME_UNITY(a, b, c, d, e) {b, SemanticTimeUnity::a},
static const std::map<std::string, SemanticTimeUnity> _semanticTimeUnity_fromStr = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY

#define SEMANTIC_TIME_UNITY(a, b, c, d, e) c,
static const std::vector<std::string> _semanticTimeUnity_toAbreviation = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY

#define SEMANTIC_TIME_UNITY(a, b, c, d, e) d,
static const std::vector<int64_t> _semanticTimeUnity_toNbOfMilliseconds = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY

#define SEMANTIC_TIME_UNITY(a, b, c, d, e) e,
static const std::vector<int> _semanticTimeUnity_toNbOfDigits = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY
...
static const std::vector<SemanticTimeUnity> semanticTimeUnities = {SEMANTIC_TIME_UNITY_TABLE};
#undef SEMANTIC_TIME_UNITY
...
static inline SemanticTimeUnity semanticTimeUnity_fromStr(const std::string& pTimeUnityStr) {
...
static inline std::string semanticTimeUnity_toAbreviation(SemanticTimeUnity pTimeUnity) {
    return _semanticTimeUnity_toAbreviation[semanticTimeUnity_toChar(pTimeUnity)];
}

static inline int64_t semanticTimeUnity_toNbOfMilliseconds(SemanticTimeUnity pTimeUnity) {
...
enum class SmanticTimeMonth { SEMANTIC_TIME_MONTH_TABLE };
#undef SEMANTIC_TIME_MONTH

#define SEMANTIC_TIME_MONTH(a, b, c) b,
static const std::vector<std::string> _semanticTimeMonth_toStr = {SEMANTIC_TIME_MONTH_TABLE};
#undef SEMANTIC_TIME_MONTH

#define SEMANTIC_TIME_MONTH(a, b, c) {b, SmanticTimeMonth::a},
static const std::map<std::string, SmanticTimeMonth> _semanticTimeMonth_fromStr = {SEMANTIC_TIME_MONTH_TABLE};
#undef SEMANTIC_TIME_MONTH

#define SEMANTIC_TIME_MONTH(a, b, c) c,
static const std::vector<int> _semanticTimeMonth_toId = {SEMANTIC_TIME_MONTH_TABLE};
#undef SEMANTIC_TIME_MONTH

#define SEMANTIC_TIME_MONTH(a, b, c) {c, SmanticTimeMonth::a},
static const std::map<int, SmanticTimeMonth> _semanticTimeMonth_fromId = {SEMANTIC_TIME_MONTH_TABLE};
#undef SEMANTIC_TIME_MONTH
...
struct ONSEM_TEXTTOSEMANTIC_API SemanticDuration {
    ...
    bool isEqualWithMarginOfError(const SemanticDuration& pOther, const SemanticDuration& pMarginOfError) const;
...
private:
    ...
    SemanticDuration _addition(const SemanticDuration& pOther, int pCoefOfOther) const;
...
inline bool SemanticDurationGrounding::isEqual(const SemanticDurationGrounding& pOther) const {
    return _isMotherClassEqual(pOther) && duration == pOther.duration;
}

}    // End of namespace onsem

#endif    // ONSEM_TEXTTOSEMANTIC_DBTYPE_SEMANTICGROUNDING_SEMANTICDURATIONGROUNDING_HPP
