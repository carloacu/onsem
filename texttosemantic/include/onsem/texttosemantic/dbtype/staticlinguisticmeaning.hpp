...
struct ONSEM_TEXTTOSEMANTIC_API StaticLinguisticMeaning {
    StaticLinguisticMeaning(SemanticLanguageEnum pLanguage, int pMeaningId);
...
inline StaticLinguisticMeaning::StaticLinguisticMeaning(SemanticLanguageEnum pLanguage, int pMeaningId)
    : language(pLanguage)
...
inline bool StaticLinguisticMeaning::operator==(const StaticLinguisticMeaning& pOther) const {
    return meaningId == pOther.meaningId && language == pOther.language;
}
