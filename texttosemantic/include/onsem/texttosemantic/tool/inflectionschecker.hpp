...
public:
  ...
  bool areCompatibles(const InflectedWord& pIGram1,
                      const InflectedWord& pIGram2) const;

  static bool areInflectionsCompatibles(const Inflections& pInfls1,
  ...
  bool verbIsConjAtPerson(const InflectedWord& pInflWord,
  ...
  bool pronounSetAtSamePers(const InflectedWord& pIGram1,
                            const InflectedWord& pIGram2) const;
  ...
  void initGenderSetFromIGram(std::set<SemanticGenderType>& pPossibleGenders,
