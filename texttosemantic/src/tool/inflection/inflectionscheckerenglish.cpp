...
bool InflectionsCheckerEnglish::isAuxVerbCompatibles(const InflectedWord& pIGramAux,
...
bool InflectionsCheckerEnglish::isVerbAdjCompatibles(const InflectedWord& pIGramVerb, const InflectedWord&) const {
...
bool InflectionsCheckerEnglish::areDetCompatibles(const InflectedWord& pInflDet1,
    ...
    if (inflections1.type != InflectionType::NOMINAL || inflections2.type != InflectionType::NOMINAL)
        return true;
...
bool InflectionsCheckerEnglish::areNounDetCompatibles(const InflectedWord& pNounInflWord,
