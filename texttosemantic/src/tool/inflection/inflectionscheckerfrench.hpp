...
public:
  ...
  bool _isVerbVerbCompatibles(const Inflections& pVerbInfl1,
                              const Inflections& pVerbInfl2) const override;
  ...
  bool isVerbSubConjonction(const InflectedWord& pInflVerb,
                            const InflectedWord& pInflSubConj) const override;
  ...
  bool areNounDetCompatibles(const InflectedWord& pNounInflWord,
                             const InflectedWord& pDetInflWord) const override { return true; }
  ...
  bool isPronounComplAdjectiveCompatibles(const InflectedWord& pInflPronCompl,
                                          const InflectedWord& pInflAdj) const { return false; }
