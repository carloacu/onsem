...
UniqueSemanticExpression emptyStatementSemExp() {
    return std::make_unique<GroundedExpression>(std::make_unique<SemanticStatementGrounding>());
}

UniqueSemanticExpression whatIs(UniqueSemanticExpression pSubjectSemExp, SemanticLanguageEnum pLanguage) {
