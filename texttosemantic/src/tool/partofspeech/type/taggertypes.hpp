#ifndef ONSEM_TEXTTOSEMANTIC_SRC_TOOL_PARTOFSPEECH_TYPE_TAGGERTYPES_HPP
#define ONSEM_TEXTTOSEMANTIC_SRC_TOOL_PARTOFSPEECH_TYPE_TAGGERTYPES_HPP
...
enum class FinderConstraint { HAS, FIRST_ELT, ONLY_ONE_ELT };

enum class CompatibilityCheck { IS_COMPATIBLE, ISNT_COMPATIBLE, DONT_CARE };

enum class LinkedValue { LINKED, NOT_LINKED, UNKNOWN };

enum class ActionIfLinked {
    DEL_ALL_OTHERS,
    DEL_ALL_EXPECT_AUX,
    DEL_LESSER_PROBA,
    DEL_LESSER_PROBA_EXPECT_PARTITIVE,
...
enum class ActionIfNotLinked { REMOVE, NOTHING };

/// Allows rules to be skipped if YES.
enum class CanBeEmpty { YES, NO };

/// Allows to retry rules that had matched if YES.
enum class CanHaveMany { YES, NO };
...
#endif    // ONSEM_TEXTTOSEMANTIC_SRC_TOOL_PARTOFSPEECH_TYPE_TAGGERTYPES_HPP
