...
private:
  ...
  void xExtractEnglishSPossessive
  (std::list<ChunkLink>& pFirstChildren) const;

  void xEnglishSPossessiveAddAOwner
  ...
  static void xEnglishSPossessiveClearContext
  (TokPosInAChunk& pItOwner,
   TokPosInAChunk& pItPoss,
   TokPosInAChunk& pItSPoss,
