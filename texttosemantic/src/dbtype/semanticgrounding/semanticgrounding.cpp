...
std::unique_ptr<SemanticGrounding> SemanticGrounding::make(SemanticGroundingType pType) {
    switch (pType) {
        case SemanticGroundingType::AGENT: return std::make_unique<SemanticAgentGrounding>();
        case SemanticGroundingType::ANGLE: return std::make_unique<SemanticAngleGrounding>();
        case SemanticGroundingType::GENERIC: return std::make_unique<SemanticGenericGrounding>();
        case SemanticGroundingType::STATEMENT: return std::make_unique<SemanticStatementGrounding>();
        case SemanticGroundingType::TIME: return std::make_unique<SemanticTimeGrounding>();
        case SemanticGroundingType::TEXT: return std::make_unique<SemanticTextGrounding>("");
        case SemanticGroundingType::DURATION: return std::make_unique<SemanticDurationGrounding>();
        ...
        case SemanticGroundingType::LENGTH: return std::make_unique<SemanticLengthGrounding>();
        case SemanticGroundingType::META:
            return std::make_unique<SemanticMetaGrounding>(SemanticGroundingType::META, 0);
        case SemanticGroundingType::NAME: return std::make_unique<SemanticNameGrounding>("");
        case SemanticGroundingType::PERCENTAGE: return std::make_unique<SemanticPercentageGrounding>();
        case SemanticGroundingType::CONCEPTUAL: return std::make_unique<SemanticConceptualGrounding>();
...
bool SemanticGrounding::operator==(const SemanticGrounding& pOther) const {
    ...
    switch (type) {
        case SemanticGroundingType::AGENT: return getAgentGrounding().isEqual(pOther.getAgentGrounding());
        case SemanticGroundingType::ANGLE: return getAngleGrounding().isEqual(pOther.getAngleGrounding());
        case SemanticGroundingType::GENERIC: return getGenericGrounding().isEqual(pOther.getGenericGrounding());
        case SemanticGroundingType::STATEMENT: return getStatementGrounding().isEqual(pOther.getStatementGrounding());
        case SemanticGroundingType::TIME: return getTimeGrounding().isEqual(pOther.getTimeGrounding());
        case SemanticGroundingType::TEXT: return getTextGrounding().isEqual(pOther.getTextGrounding());
        case SemanticGroundingType::DURATION: return getDurationGrounding().isEqual(pOther.getDurationGrounding());
        case SemanticGroundingType::LANGUAGE: return getLanguageGrounding().isEqual(pOther.getLanguageGrounding());
        case SemanticGroundingType::RELATIVELOCATION:
            return getRelLocationGrounding().isEqual(pOther.getRelLocationGrounding());
        case SemanticGroundingType::RELATIVETIME: return getRelTimeGrounding().isEqual(pOther.getRelTimeGrounding());
        case SemanticGroundingType::RELATIVEDURATION:
            return getRelDurationGrounding().isEqual(pOther.getRelDurationGrounding());
        case SemanticGroundingType::RESOURCE: return getResourceGrounding().isEqual(pOther.getResourceGrounding());
        case SemanticGroundingType::LENGTH: return getLengthGrounding().isEqual(pOther.getLengthGrounding());
        case SemanticGroundingType::META: return getMetaGrounding().isEqual(pOther.getMetaGrounding());
        case SemanticGroundingType::NAME: return getNameGrounding().isEqual(pOther.getNameGrounding());
        ...
        case SemanticGroundingType::UNITY: return getUnityGrounding().isEqual(pOther.getUnityGrounding());
    }
    assert(false);
    return false;
}
...
bool SemanticGrounding::_isMotherClassEqual(const SemanticGrounding& pOther) const {
    return polarity == pOther.polarity && concepts == pOther.concepts;
}
...
bool SemanticGrounding::isEmpty() const {
    ...
    return cptGrd != nullptr && cptGrd->concepts.empty();
}
