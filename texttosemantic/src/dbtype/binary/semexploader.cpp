                ...
                const unsigned char*& pPtr)
{
  ...
  for (unsigned char i = 0; i < nbOfAngleInfos; ++i)
  {
    ...
    ++pPtr;
    _loadSemanticFloat(pAngle.angleInfos[angleUnity], pPtr, _loadCharOrInt(pPtr, charOrInt));
  }
}
                 ...
                 const unsigned char*& pPtr)
{
  ...
  for (unsigned char i = 0; i < nbOflengthInfos; ++i)
  {
    ...
    ++pPtr;
    _loadSemanticFloat(pLength.lengthInfos[lengthUnity], pPtr, _loadCharOrInt(pPtr, charOrInt));
  }
}
                   ...
                   const unsigned char*& pPtr)
{
  ...
  for (unsigned char i = 0; i < nbOfTimeInfos; ++i)
  {
    ...
    ++pPtr;
    _loadSemanticFloat(pDuration.timeInfos[timeUnity], pPtr, _loadCharOrInt(pPtr, charOrInt));
  }
}
