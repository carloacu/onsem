...
std::unique_ptr<Inflections> Inflections::create(InflectionType pType,
                                                 const std::vector<std::string>& pInflectionalCodes) {
    switch (pType) {
        case InflectionType::ADJECTIVAL: return std::make_unique<AdjectivalInflections>(pInflectionalCodes);
        case InflectionType::NOMINAL: return std::make_unique<NominalInflections>(pInflectionalCodes);
        case InflectionType::PRONOMINAL: return std::make_unique<PronominalInflections>(pInflectionalCodes);
        case InflectionType::VERBAL: return std::make_unique<VerbalInflections>(pInflectionalCodes);
...
std::unique_ptr<Inflections> Inflections::create(InflectionType pType, const std::string& pInflectionalCodes) {
...
std::unique_ptr<Inflections> Inflections::clone() const {
    switch (type) {
        case InflectionType::ADJECTIVAL: return std::make_unique<AdjectivalInflections>(getAdjectivalI());
        case InflectionType::NOMINAL: return std::make_unique<NominalInflections>(getNominalI());
        case InflectionType::PRONOMINAL: return std::make_unique<PronominalInflections>(getPronominalI());
        case InflectionType::VERBAL: return std::make_unique<VerbalInflections>(getVerbalI());
        case InflectionType::EMPTY: return std::make_unique<EmptyInflections>();
    }
    assert(false);
    return std::unique_ptr<Inflections>();
...
bool Inflections::operator==(const Inflections& pOther) const {
    if (type != pOther.type)
        return false;
    switch (type) {
        case InflectionType::ADJECTIVAL: return getAdjectivalI() == pOther.getAdjectivalI();
        case InflectionType::NOMINAL: return getNominalI() == pOther.getNominalI();
        case InflectionType::PRONOMINAL: return getPronominalI() == pOther.getPronominalI();
        case InflectionType::VERBAL: return getVerbalI() == pOther.getVerbalI();
        case InflectionType::EMPTY: return true;
    }
    assert(false);
    return true;
}
...
void Inflections::concisePrint(std::ostream& pOs) const {
    switch (type) {
        case InflectionType::ADJECTIVAL: pOs << getAdjectivalI(); break;
        case InflectionType::NOMINAL: pOs << getNominalI(); break;
        case InflectionType::PRONOMINAL: pOs << getPronominalI(); break;
        case InflectionType::VERBAL: pOs << getVerbalI(); break;
        case InflectionType::EMPTY: break;
    }
}
