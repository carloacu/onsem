 ...
 const SpecificLinguisticDatabase& pSpecLingDb)
{
...

      {
        ...
        verbGramType.elts.emplace_back
            (PartOfSpeech::VERB, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_ALL_OTHERS, ActionIfNotLinked::NOTHING,
             LinkedValue::UNKNOWN);
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      ...
      {
        TaggerListOfTokenChecks verbGramType;
        verbGramType.elts.emplace_back(PartOfSpeech::VERB, FinderConstraint::FIRST_ELT,
...

      {
        ...
        advGramType.elts.emplace_back
            (PartOfSpeech::UNKNOWN, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_LESSER_PROBA);
       advGramType.elts.emplace_back
            (PartOfSpeech::ADVERB, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_LESSER_PROBA);
       advGramType.elts.emplace_back
        ...
        ([]
    {
      AIGramContext resContext;
      {
        ...
        adjGramType.elts.emplace_back
            (PartOfSpeech::ADJECTIVE, FinderConstraint::HAS, CompatibilityCheck::DONT_CARE,
             ActionIfLinked::DEL_ALL_OTHERS);
        resContext.after.emplace_back(adjGramType);
      }
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      AIGramContext resContext;
      {
        ...
        conjGramType.elts.emplace_back
            (PartOfSpeech::CONJUNCTIVE, FinderConstraint::FIRST_ELT, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_ALL_OTHERS);
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([&advGramType]
    {
      ...
      resContext.after.emplace_back(advGramType);
      {
        ...
        finalGramType.elts.emplace_back
            (PartOfSpeech::CONJUNCTIVE, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_LESSER_PROBA);
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      ...
      detOrPunctuationGramTypes.elts.emplace_back([] (const InflectedWord& pInflWord)
      {
        return pInflWord.word.partOfSpeech == PartOfSpeech::DETERMINER ||
      ...
      notNounGramType.elts.emplace_back
          ([] (const InflectedWord& pInflWord)
      {
        return !partOfSpeech_isNominal(pInflWord.word.partOfSpeech);
      },
      FinderConstraint::FIRST_ELT);
