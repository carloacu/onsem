 ...
 const SpecificLinguisticDatabase& pSpecLingDb)
{
  ...
  rules.emplace_back([&pInfls]
  {
    auto res = std::make_unique<PartOfSpeechPatternMatcher>
        ("for-verb", pInfls,
         TaggerTokenCheck
             ...
             {
               return pInflWord.word.lemma == "for";
             },
        ...
        ([&pInfls]
    {
      AIGramContext resContext;
      {
        ...
        FinderConstraint::HAS, CompatibilityCheck::DONT_CARE,
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      AIGramContext resContext;
      {
        TaggerListOfTokenChecks pron_subjGramType;
        pron_subjGramType.elts.emplace_back
            (PartOfSpeech::PROPER_NOUN, FinderConstraint::HAS, CompatibilityCheck::DONT_CARE,
             ActionIfLinked::DEL_ALL_OTHERS);
        resContext.after.emplace_back(pron_subjGramType);
      }
  ...
  rules.emplace_back([&pSpecLingDb, &pInfls]
  {
    ...
    // for an affirmation
    pattern.possibilities.emplace_back
        ([&auxGramType, &advGramType, &verbGramType]
    {
      AIGramContext resContext;
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      AIGramContext resContext;
      {
        TaggerListOfTokenChecks advGramType(CanBeEmpty::YES, CanHaveMany::YES);
        advGramType.elts.emplace_back
            (PartOfSpeech::ADVERB, FinderConstraint::FIRST_ELT, CompatibilityCheck::DONT_CARE,
             ActionIfLinked::DEL_ALL_OTHERS);
        resContext.after.emplace_back(advGramType);
      }
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      AIGramContext resContext;
      {
        TaggerListOfTokenChecks prepGramType;
        prepGramType.elts.emplace_back
            (PartOfSpeech::PRONOUN_COMPLEMENT, FinderConstraint::FIRST_ELT, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_ALL_OTHERS);
        resContext.after.emplace_back(prepGramType);
      }
      return resContext;
  ...
  rules.emplace_back([&pInfls]
  {
        ...
        ([]
    {
      AIGramContext resContext;
      {
        ...
        detGramType.elts.emplace_back(PartOfSpeech::VERB, FinderConstraint::HAS, CompatibilityCheck::DONT_CARE,
                                      ActionIfLinked::NOTHING, ActionIfNotLinked::NOTHING,
                                      LinkedValue::UNKNOWN);
  ...
  rules.emplace_back([&pInfls]
  {
    auto res = std::make_unique<PartOfSpeechPatternMatcher>
        ("adj links", pInfls,
         TaggerTokenCheck
                  (PartOfSpeech::ADJECTIVE, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
                   ActionIfLinked::DEL_LESSER_PROBA, ActionIfNotLinked::REMOVE));
        ...
        ([&advGramType]
    {
      ...
      nounGramTypes.elts.emplace_back
          (PartOfSpeech::NOUN,
           FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE);
      nounGramTypes.elts.emplace_back
          (PartOfSpeech::PROPER_NOUN, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
           ActionIfLinked::DEL_LESSER_PROBA);
      nounGramTypes.elts.emplace_back
        ...
        ([]
    {
      ...
      }
      {
        ...
        verbGramTypes.elts.emplace_back
            (PartOfSpeech::VERB, FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
             ActionIfLinked::DEL_LESSER_PROBA, ActionIfNotLinked::NOTHING,
             LinkedValue::UNKNOWN);
        ...
        ([&advGramType]
    {
      ...
      FinderConstraint::HAS, CompatibilityCheck::IS_COMPATIBLE,
      ActionIfLinked::DEL_LESSER_PROBA, ActionIfNotLinked::NOTHING, LinkedValue::UNKNOWN);
      resContext.before.emplace_back(nounGramTypes);
      return resContext;
    }());
