...
public:
     ...
     */
    std::size_t findQueAddQu(LinguisticIntermediaryDatabase& pLingDatabase) const;
     ...
     */
    void associateANewGramForAMeaning(LinguisticIntermediaryDatabase& pLingDatabase,
                                      const std::string& pLemma,
                                      PartOfSpeech pRefPartOfSpeech,
                                      PartOfSpeech pNewPartOfSpeech) const;

    std::size_t addToAtBeginOfVerbsForEnglish(LinguisticIntermediaryDatabase& pLingDatabase) const;
     ...
     */
    std::size_t delExprs(LinguisticIntermediaryDatabase& pLingDatabase) const;
     ...
     * @return The number of words deleted.
     */
    std::size_t delAllWords(LinguisticIntermediaryDatabase& pLingDatabase) const;
...
private:
     ...
     */
    bool xEndWithQue(const std::string& pWord) const;

    bool xEndWithQuApostrophe(const std::string& pWord) const;
     ...
     */
    LingdbWordForms* xGetWordFormThatAsASpecificMeaning(const ForwardPtrList<LingdbWordForms>* pWf,
