...
protected:
    ...
    binarymasks::Ptr xWriteString(binarymasks::Ptr pEndMemory, const LingdbString* pString) const;

    template<typename T>
    binarymasks::Ptr xCreateRootNode(T& pTreeCreationWorkState,
                                     LingdbDynamicTrieNode* pNode,
                                     const binarymasks::Ptr pBeginMemory,
                                     binarymasks::Ptr pEndMemory) const;

    template<typename T>
    binarymasks::Ptr xIterateOnChildren(T& pTreeCreationWorkState,
                                        int pParentPtr,
                                        LingdbDynamicTrieNode* pNode,
                                        const binarymasks::Ptr pBeginMemory,
    ...
    template<typename T>
    binarymasks::Ptr xAddANode(T& pTreeCreationWorkState,
                               int pParentPtr,
                               LingdbDynamicTrieNode* pNode,
                               const binarymasks::Ptr pBeginMemory,
                               binarymasks::Ptr pEndMemory) const;
     ...
     */
    unsigned char xMaxNbOfLettersInTheNode(LingdbDynamicTrieNode* pNode) const;
};
