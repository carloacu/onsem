    ...
    case 'w':
    {
      _readAttributtes(line, beanNamePos, [&](char pAttrName, const std::string& pAttrValue) {
        ...
        case 'l':
          ...
          break;
        case 'p':
          currentLemmaPos = partOfSpeech_fromStr(pAttrValue);
          break;
        }
      });
      break;
    ...
    case 'i':
    {
      ...
      _readAttributtes(line, beanNamePos, [&](char pAttrName, const std::string& pAttrValue) {
        ...
        case 'p':
          ...
          break;
        case 'f':
          mystd::splitNotEmpty(flexions, pAttrValue, "|");
          break;
        case 'y':
          frequency = mystd::lexical_cast<char>(pAttrValue);
          break;
        }
      });
      pWords.addWord(word, currentLemma, inflPos,
                     flexions, frequency);
      break;
    }
