...
private:
    ...
    */
     ...
     */
    static void xSplit(std::vector<std::string>& pItems, const std::string& pStr, char pDelim);

    static LingdbMeaning* xExtractMeaning(const boost::property_tree::ptree& pTree,
