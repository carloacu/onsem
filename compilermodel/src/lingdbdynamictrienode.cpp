...
void LingdbDynamicTrieNode::xInit
(char pLetter)
{
  fEndOfWord = false;
  fLetter = pLetter;
...
void LingdbDynamicTrieNode::putAWordFormAtTheTopOfTheList
(PartOfSpeech pGram,
...
LingdbMeaning* LingdbDynamicTrieNode::getMeaning
...
LingdbWordForms* LingdbDynamicTrieNode::getWordForm
(const std::string& pLemme,
 PartOfSpeech pPartOfSpeech) const
{
...
LingdbWordForms* LingdbDynamicTrieNode::getWordFormFromMeaning
...
unsigned char LingdbDynamicTrieNode::nbMeaningsAtThisLemme
() const
{
...
unsigned char LingdbDynamicTrieNode::nbWordForms
() const
{
  if (fWordForms == nullptr)
  {
...
(std::list<std::pair<LingdbWordForms*, LingdbMeaning*> >& pWordFromsOrMeanings) const
{
  ...
  while (itWordForm != nullptr)
  {
    ...
    pWordFromsOrMeanings.emplace_back
        (std::pair<LingdbWordForms*, LingdbMeaning*>(itWordForm->elt, nullptr));
    itWordForm = itWordForm->next;
  }
  ...
  while (itMeaning != nullptr)
  {
    ...
    {
      pWordFromsOrMeanings.emplace_back
          (std::pair<LingdbWordForms*, LingdbMeaning*>(nullptr, itMeaning->elt));
    }
    itMeaning = itMeaning->next;
  }
}
 ...
 std::list<std::pair<LingdbMeaning*, LinkedMeaningDirection> >& pLinkedMeanings)
{
  ...
  ForwardPtrList<LingdbDynamicTrieNode>* newNodeList =
      pAlloc.allocate<ForwardPtrList<LingdbDynamicTrieNode> >(1);
 ...
 PartOfSpeech pPartOfSpeech)
{
  ...
  if (meaning == nullptr)
  {
    ...
    ForwardPtrList<LingdbMeaning>* newMeaningList =
        pFPAlloc.allocate<ForwardPtrList<LingdbMeaning> >(1);
...
LingdbWordForms* LingdbDynamicTrieNode::addWordForm
...
LingdbWordForms* LingdbDynamicTrieNode::addWordFormFromMeaning
(LinguisticIntermediaryDatabase& pLingDatabase,
 ...
 bool pAtFront)
{
  ...
  ForwardPtrList<LingdbWordForms>* newWordFormList =
      pAlloc.allocate<ForwardPtrList<LingdbWordForms> >(1);
 ...
 PartOfSpeech pPartOfSpeech)
{
  ...
  while (curr != nullptr)
  {
    ...
    {
      if (prev == nullptr)
        ForwardPtrList<LingdbWordForms>::clearNextComposedElt
            (fWordForms, pAlloc);
      else
        ForwardPtrList<LingdbWordForms>::clearNextComposedElt
            (prev->next, pAlloc);
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::advanceInTrieIfEndOfAWord
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::advanceInTrie
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::getNextWordNode
() const
{
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::xGetWordNode
() const
{
  if (fEndOfWord)
  {
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::xGetChild
(char pLetter) const
{
  if (fFirstChild == nullptr)
  {
...
LingdbDynamicTrieNode* LingdbDynamicTrieNode::xGetBrother
(char pLetter) const
{
...
unsigned char LingdbDynamicTrieNode::nbSupBrother
() const
{
  char res = 0;
  LingdbDynamicTrieNode const* children = this;
...
std::string LingdbDynamicTrieNode::getWord
(bool pNaturalLangPrint) const
{
  ...
  {
    const ForwardPtrList<LingdbNodeLinkedMeaning>*
