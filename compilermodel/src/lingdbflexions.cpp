...
unsigned char LingdbFlexions::getNbFlexions
() const
{
  return fNbFlexions;
}
...
const unsigned char* LingdbFlexions::getMemory
() const
{
  return fFlexions;
}

void LingdbFlexions::writeInStream
(std::ostream& pOs,
...
void LingdbFlexions::xGetPointers
(std::vector<const void*>& pRes, void* pVar)
{
  pRes.emplace_back(&reinterpret_cast<LingdbFlexions*>
                 (pVar)->fFlexions);
}

char LingdbFlexions::xFlexionStringToChar
(PartOfSpeech pGram,
...
char LingdbFlexions::xFlexionStringToCharForNoun
...
char LingdbFlexions::xFlexionStringToCharForPronoun
(const std::string& pFlexion) const
{
  std::size_t i = 0;
  char res = 0;
...
void LingdbFlexions::fillVerbConjugaison
...
void LingdbFlexions::fillNounConjugaison
...
void LingdbFlexions::xFillImperativeVerbTense
...
void LingdbFlexions::xFillVerbTense
(std::vector<WordLinkForConj>& pVerbTense,
 char pCurrFlexion,
 const LingdbDynamicTrieNode* pTriNode,
 char pFrequency) const
...
bool LingdbFlexions::replaceInfinitiveByImperative
() const
{
  for (unsigned char i = 0; i < fNbFlexions; ++i)
  {
...
char LingdbFlexions::xFlexionStringToCharForVerb
(const std::string& pFlexion) const
{
  unsigned char res = 0;
