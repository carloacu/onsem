    ...
    fConceptNameToPtr()
{
  ...
  fAlloc.addANewLeaf<LingdbDynamicTrieNode>("a node of the trie", alignementMemory, LingdbDynamicTrieNode::xGetPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbMeaning> >("list of meanings", alignementMemory, ForwardPtrList<LingdbMeaning>::getPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbWordForms> >("list of word forms", alignementMemory, ForwardPtrList<LingdbWordForms>::getPointers);
  ...
  fAlloc.addANewLeaf<ForwardPtrList<LingdbQuestionWords::AQuestionWord> >("a question words list", alignementMemory, ForwardPtrList<LingdbQuestionWords::AQuestionWord>::getPointers);
  ...
  fAlloc.addANewLeaf<LingdbLinkToAConcept>("a link to a concept", alignementMemory, LingdbLinkToAConcept::xGetPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbLinkToAConcept> >("a list of all the links to a concept", alignementMemory, ForwardPtrList<LingdbLinkToAConcept>::getPointers);
  fAlloc.addANewLeaf<LingdbConcept>("a concept", alignementMemory, LingdbConcept::xGetPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbConcept> >("a list of all the concepts", alignementMemory, ForwardPtrList<LingdbConcept>::getPointers);
  fAlloc.addANewLeaf<LingdbString>("a string in the concept composite", alignementMemory, LingdbString::xGetPointers);

  fAlloc.addANewLeaf<LingdbMultiMeaningsNode>("a multi meanings node", alignementMemory, LingdbMultiMeaningsNode::getPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbDynamicTrieNode> >("a list of dynamic trie nodes", alignementMemory, ForwardPtrList<LingdbDynamicTrieNode>::getPointers);
  fAlloc.addANewLeaf<LingdbNodeLinkedMeaning>("a linked meaning", alignementMemory, LingdbNodeLinkedMeaning::getPointers);
  fAlloc.addANewLeaf<ForwardPtrList<LingdbNodeLinkedMeaning> >("a list of linked meanings", alignementMemory, ForwardPtrList<LingdbNodeLinkedMeaning>::getPointers);
...
LingdbMeaning* LinguisticIntermediaryDatabase::getMeaning
 ...
 PartOfSpeech pPartOfSpeech) const
{
  ...
  const ForwardPtrList<LingdbDynamicTrieNode>*
...
LingdbConcept* LinguisticIntermediaryDatabase::getConcept
...
LingdbConcept* LinguisticIntermediaryDatabase::addConcept
 ...
 PartOfSpeech pPartOfSpeech)
{
  ...
  LingdbDynamicTrieNode* newNode = simpleLemme->xAddMultiMeaningsNode
 ...
 PartOfSpeech pPartOfSpeech)
{
  ...
  while (multiMeaningNodes != nullptr)
  {
    const ForwardPtrList<LingdbDynamicTrieNode>* nextMultiMeaningNodes =
...
LingdbDynamicTrieNode* LinguisticIntermediaryDatabase::getPointerToEndOfWord
...
LingdbQuestionWords* LinguisticIntermediaryDatabase::getQuestionWords
() const
{
  return fInfos->questionWords;
}

LingdbDynamicTrieNode* LinguisticIntermediaryDatabase::getPointerInTrie
(const std::string& word) const
{
  if (!fRoot)
  {
...
LingdbDynamicTrieNode* LinguisticIntermediaryDatabase::findComposedWordFromString
...
(const ForwardPtrList<LingdbDynamicTrieNode>*& pMultiMeaningNodes,
