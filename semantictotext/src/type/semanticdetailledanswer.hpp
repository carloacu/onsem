...
struct ConditionResult {
    ConditionResult(const ConditionSpecification& pCondition,
...
struct ConditionForAUser {
    ...
    ConditionForAUser(const std::string& pUser, std::unique_ptr<SemanticExpression> pThenSemExp);
...
struct LeafSemAnswer : public SemAnswer {
    ...
    LeafSemAnswer(ContextualAnnotation pType, UniqueSemanticExpression pReaction);
    ...
    LeafSemAnswer(ContextualAnnotation pType, UniqueSemanticExpression pReaction, ConditionForAUser pConditionForAUser);
...
struct CompositeSemAnswer : public SemAnswer {
    ...
    static void getGrdExps(std::list<const GroundedExpression*>& pGrdExps,
