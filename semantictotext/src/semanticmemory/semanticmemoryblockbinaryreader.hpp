...
struct SemanticMemoryBlockBinaryReader {
    ...
    static const unsigned char* getLinksForARequest(const unsigned char* pPtr, SemanticRequestType pRequest);
    ...
    bool areSameUser(const std::string& pUserId1, const std::string& pUserId2) const;
