...
struct SemanticAnnotations
{
  ...
  virtual void iterateOverAllValues(const std::function<void(GrammaticalType, const SemanticExpression&)>& pOnElement) const = 0;
};
...
struct SemanticAnnotationsPtrs : public SemanticAnnotations
{
  ...
  void iterateOverAllValues(const std::function<void(GrammaticalType, const SemanticExpression&)>& pOnElement) const override
  {
...
struct SemanticAnnotationsInstances : public SemanticAnnotations
{
  ...
  void addAnnotation(GrammaticalType pGrammaticalType,
