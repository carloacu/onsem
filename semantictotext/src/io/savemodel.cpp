...
struct GrdExpLinks {
    ...
    int getNewLink() { return nextLink++; }
...
void _saveSemExp(boost::property_tree::ptree& pTree, const SemanticExpression& pSemExp, GrdExpLinks* pGrdExpLinks);
...
void _saveGrd(boost::property_tree::ptree& pTree, const SemanticGrounding& pGrd) {
...
void _saveNameInfos(boost::property_tree::ptree& pTree, const NameInfos& pNameInfos) {
    {
...
void _saveNameGrd(boost::property_tree::ptree& pTree, const SemanticNameGrounding& pNameGrd) {
    _saveGrd(pTree, pNameGrd);
    _saveNameInfos(pTree, pNameGrd.nameInfos);
}

void _saveUnityGrd(boost::property_tree::ptree& pTree, const SemanticUnityGrounding& pUnityGrd) {
...
void _saveSemanticAngle(boost::property_tree::ptree& pTree, const SemanticAngle& pSemanticAngle) {
...
void _saveSemanticLength(boost::property_tree::ptree& pTree, const SemanticLength& pSemanticLength) {
...
void _saveSemanticDuration(boost::property_tree::ptree& pTree, const SemanticDuration& pSemanticDuration) {
...
void _saveSemanticDate(boost::property_tree::ptree& pTree, const SemanticDate& pSemanticDate) {
...
void _saveTimeGrd(boost::property_tree::ptree& pTree, const SemanticTimeGrounding& pTimeGrd) {
...
void _saveTextGrd(boost::property_tree::ptree& pTree, const SemanticTextGrounding& pTextGrd) {
...
void _saveAngleGrd(boost::property_tree::ptree& pTree, const SemanticAngleGrounding& pAngleGrd) {
    _saveGrd(pTree, pAngleGrd);
    _saveSemanticAngle(pTree.put_child("angle", {}), pAngleGrd.angle);
}

void _saveLengthGrd(boost::property_tree::ptree& pTree, const SemanticLengthGrounding& pLengthGrd) {
    _saveGrd(pTree, pLengthGrd);
    _saveSemanticLength(pTree.put_child("length", {}), pLengthGrd.length);
}

void _savePercentageGrd(boost::property_tree::ptree& pTree, const SemanticPercentageGrounding& pGrd) {
    _saveGrd(pTree, pGrd);
    pTree.put("value", pGrd.value.toStr());
}

void _saveDurationGrd(boost::property_tree::ptree& pTree, const SemanticDurationGrounding& pDurationGrd) {
    _saveGrd(pTree, pDurationGrd);
    _saveSemanticDuration(pTree.put_child("duration", {}), pDurationGrd.duration);
}

void _saveLanguageGrd(boost::property_tree::ptree& pTree, const SemanticLanguageGrounding& pLangGrd) {
...
void _saveRelativeLocationGrd(boost::property_tree::ptree& pTree, const SemanticRelativeLocationGrounding& pRelLocGrd) {
    _saveGrd(pTree, pRelLocGrd);
    pTree.put("locationType", semanticRelativeLocationType_toStr(pRelLocGrd.locationType));
}

void _saveRelativeTimeGrd(boost::property_tree::ptree& pTree, const SemanticRelativeTimeGrounding& pRelTimeGrd) {
...
void _saveResourceGrd(boost::property_tree::ptree& pTree, const SemanticResourceGrounding& pResourceGrd) {
...
void _saveMetaGrd(boost::property_tree::ptree& pTree, const SemanticMetaGrounding& pMetaGrd) {
...
void _saveSemanticWord(boost::property_tree::ptree& pTree, const SemanticWord& pWord) {
...
void _saveGenericGrd(boost::property_tree::ptree& pTree, const SemanticGenericGrounding& pGenGrd) {
...
void _saveStatementGrd(boost::property_tree::ptree& pTree, const SemanticStatementGrounding& pStatGrd) {
...
void _saveGrounding(boost::property_tree::ptree& pTree, const SemanticGrounding& pGrounding) {
    switch (pGrounding.type) {
        case SemanticGroundingType::AGENT: _saveAgentGrd(pTree, pGrounding.getAgentGrounding()); return;
        case SemanticGroundingType::ANGLE: _saveAngleGrd(pTree, pGrounding.getAngleGrounding()); return;
        case SemanticGroundingType::GENERIC: _saveGenericGrd(pTree, pGrounding.getGenericGrounding()); return;
        case SemanticGroundingType::STATEMENT: _saveStatementGrd(pTree, pGrounding.getStatementGrounding()); return;
        case SemanticGroundingType::TIME: _saveTimeGrd(pTree, pGrounding.getTimeGrounding()); return;
        case SemanticGroundingType::TEXT: _saveTextGrd(pTree, pGrounding.getTextGrounding()); return;
        case SemanticGroundingType::DURATION: _saveDurationGrd(pTree, pGrounding.getDurationGrounding()); return;
        case SemanticGroundingType::LANGUAGE: _saveLanguageGrd(pTree, pGrounding.getLanguageGrounding()); return;
        case SemanticGroundingType::RELATIVELOCATION:
            _saveRelativeLocationGrd(pTree, pGrounding.getRelLocationGrounding());
            return;
        case SemanticGroundingType::RELATIVETIME: _saveRelativeTimeGrd(pTree, pGrounding.getRelTimeGrounding()); return;
        case SemanticGroundingType::RELATIVEDURATION:
            _saveRelativeDurationGrd(pTree, pGrounding.getRelDurationGrounding());
            return;
        case SemanticGroundingType::RESOURCE: _saveResourceGrd(pTree, pGrounding.getResourceGrounding()); return;
        case SemanticGroundingType::LENGTH: _saveLengthGrd(pTree, pGrounding.getLengthGrounding()); return;
        case SemanticGroundingType::META: _saveMetaGrd(pTree, pGrounding.getMetaGrounding()); return;
        case SemanticGroundingType::NAME: _saveNameGrd(pTree, pGrounding.getNameGrounding()); return;
        case SemanticGroundingType::PERCENTAGE: _savePercentageGrd(pTree, pGrounding.getPercentageGrounding()); return;
        case SemanticGroundingType::CONCEPTUAL: _saveGrd(pTree, pGrounding); return;
        case SemanticGroundingType::UNITY: _saveUnityGrd(pTree, pGrounding.getUnityGrounding()); return;
    }
    assert(false);
}

void _saveGrdExp(boost::property_tree::ptree& pTree, const GroundedExpression& pGrdExp, GrdExpLinks* pGrdExpLinks) {
    _saveGrounding(pTree.put_child("grounding", {}), pGrdExp.grounding());
    for (const auto& currChild : pGrdExp.children)
        _saveSemExp(pTree.put_child(grammaticalType_toStr(currChild.first), {}), *currChild.second, pGrdExpLinks);
}

void _saveListExp(boost::property_tree::ptree& pTree, const ListExpression& pListExp, GrdExpLinks* pGrdExpLinks) {
...
void _saveConditionExp(boost::property_tree::ptree& pTree,
    ...
    _saveSemExp(pTree.put_child("conditionExp", {}), *pCondExp.conditionExp, pGrdExpLinks);
    _saveSemExp(pTree.put_child("thenExp", {}), *pCondExp.thenExp, pGrdExpLinks);
    if (pCondExp.elseExp)
        _saveSemExp(pTree.put_child("elseExp", {}), **pCondExp.elseExp, pGrdExpLinks);
}
...
void _saveComparisonExp(boost::property_tree::ptree& pTree,
    ...
    if (pCompExp.whatIsComparedExp)
        _saveSemExp(pTree.put_child("whatIsComparedExp", {}), **pCompExp.whatIsComparedExp, pGrdExpLinks);
    _saveSemExp(pTree.put_child("leftOperandExp", {}), *pCompExp.leftOperandExp, pGrdExpLinks);
    if (pCompExp.rightOperandExp)
        _saveSemExp(pTree.put_child("rightOperandExp", {}), **pCompExp.rightOperandExp, pGrdExpLinks);
}
...
void _saveInterpretationExp(boost::property_tree::ptree& pTree,
    ...
    _saveSemExp(pTree.put_child("interpretedExp", {}), *pIntExp.interpretedExp, pGrdExpLinks);
    _saveSemExp(pTree.put_child("originalExp", {}), *pIntExp.originalExp, pGrdExpLinks);
}

void _saveFeedbackExp(boost::property_tree::ptree& pTree,
                      const FeedbackExpression& pFdkExp,
                      GrdExpLinks* pGrdExpLinks) {
    _saveSemExp(pTree.put_child("feedbackExp", {}), *pFdkExp.feedbackExp, pGrdExpLinks);
    _saveSemExp(pTree.put_child("concernedExp", {}), *pFdkExp.concernedExp, pGrdExpLinks);
}
...
void _saveAnnotatedExp(boost::property_tree::ptree& pTree,
    ...
    for (const auto& currAnn : pAnnExp.annotations)
        _saveSemExp(pTree.put_child(grammaticalType_toStr(currAnn.first), {}), *currAnn.second, pGrdExpLinks);
}
...
void _saveCommandExp(boost::property_tree::ptree& pTree, const CommandExpression& pCmdExp, GrdExpLinks* pGrdExpLinks) {
    _saveSemExp(pTree.put_child("semExp", {}), *pCmdExp.semExp, pGrdExpLinks);
    if (pCmdExp.description)
        _saveSemExp(pTree.put_child("description", {}), **pCmdExp.description, pGrdExpLinks);
}
...
void _saveSemExp(boost::property_tree::ptree& pTree, const SemanticExpression& pSemExp, GrdExpLinks* pGrdExpLinks) {
    ...
    switch (pSemExp.type) {
        ...
        case SemanticExpressionType::LIST: _saveListExp(pTree, pSemExp.getListExp(), pGrdExpLinks); return;
        case SemanticExpressionType::CONDITION: _saveConditionExp(pTree, pSemExp.getCondExp(), pGrdExpLinks); return;
        case SemanticExpressionType::COMPARISON: _saveComparisonExp(pTree, pSemExp.getCompExp(), pGrdExpLinks); return;
        case SemanticExpressionType::INTERPRETATION:
            _saveInterpretationExp(pTree, pSemExp.getIntExp(), pGrdExpLinks);
            return;
        case SemanticExpressionType::FEEDBACK: _saveFeedbackExp(pTree, pSemExp.getFdkExp(), pGrdExpLinks); return;
        case SemanticExpressionType::ANNOTATED: _saveAnnotatedExp(pTree, pSemExp.getAnnExp(), pGrdExpLinks); return;
        case SemanticExpressionType::METADATA: _saveMetadataExp(pTree, pSemExp.getMetadataExp(), pGrdExpLinks); return;
        case SemanticExpressionType::SETOFFORMS:
            _saveSetOfFormsExp(pTree, pSemExp.getSetOfFormsExp(), pGrdExpLinks);
            return;
        case SemanticExpressionType::COMMAND: _saveCommandExp(pTree, pSemExp.getCmdExp(), pGrdExpLinks); return;
...
void _saveMemorySentence(boost::property_tree::ptree& pTree,
    ...
    if (!annotations.empty()) {
        ...
        for (const auto& currAnn : annotations)
            annotationsTree.put(grammaticalType_toStr(currAnn.first), pGrdExpLinks.getLinkOfSemExp(*currAnn.second));
    }
...
void _saveContextAxiom(boost::property_tree::ptree& pTree,
    ...
    if (pMemContextAxiom.triggerAxiomId.isEmpty()) {
        ...
        if (pMemContextAxiom.triggerAxiomId.listExpType != ListExpressionType::UNRELATED)
            triggerAxiomIdChild.put("listExpType",
                                    listExpressionType_toStr(pMemContextAxiom.triggerAxiomId.listExpType));
    }
...
void _saveMemoryKnowledge(boost::property_tree::ptree& pTree, const ExpressionWithLinks& pMemKnowledge) {
    ...
    if (pMemKnowledge.outputToAnswerIfTriggerHasMatched)
        _saveSemExp(pTree.put_child("outputToAnswerIfTriggerHasMatched", {}),
                    **pMemKnowledge.outputToAnswerIfTriggerHasMatched,
                    nullptr);
}

void _saveMemoryBlock(boost::property_tree::ptree& pTree, const SemanticMemoryBlock& pMemBlock) {
...
void _saveSemMemory(boost::property_tree::ptree& pTree, const SemanticMemory& pSemMemory) {
    ...
    const std::map<std::string, std::list<UniqueSemanticExpression>>& newUserFocusedToSemExps =
        pSemMemory.getNewUserFocusedToSemExps();
    if (!newUserFocusedToSemExps.empty()) {
        boost::property_tree::ptree& newUserFocusedToKnowledgesChild = pTree.put_child("newUserFocusedToSemExps", {});
...
void _saveConcetSet(boost::property_tree::ptree& pTree, const ConceptSet& pConceptSet) {
    const auto& localConcepts = pConceptSet.getLocalConcepts();
    if (!localConcepts.empty()) {
        boost::property_tree::ptree& localConceptsChild = pTree.put_child("localConcepts", {});
    ...
    if (!oppositeConcepts.empty()) {
        boost::property_tree::ptree& oppositeConceptsChild = pTree.put_child("oppositeConcepts", {});
...
void _saveLingWordsGroup(boost::property_tree::ptree& pTree, const linguistics::LingWordsGroup& pLingWordsGroup) {
...
void _saveWordAssociatedInfos(boost::property_tree::ptree& pTree, const linguistics::WordAssociatedInfos& pInfos) {
    ...
    if (!pInfos.contextualInfos.empty()) {
        ...
        for (const auto& currContextualInfo : pInfos.contextualInfos)
            contextualInfosChild.put("e", wordContextualInfos_toStr(currContextualInfo));
    }
...
void _saveLingDatabase(boost::property_tree::ptree& pTree, const linguistics::LinguisticDatabase& pLingDb) {
