...
struct UserInfosContainer {
    ...
    virtual void addNames(const std::string& pUserId, const std::vector<std::string>& pNames) = 0;
    virtual void addGenders(const std::string& pUserId, const std::set<SemanticGenderType>& pPossibleGenders) = 0;
    virtual void addEquivalentUserIds(const std::string& pSubjectUserId, const std::string& pObjectUserId) = 0;
    virtual void addGrdExpToUserId(const GroundedExpression& pSubjectGrdExp, const std::string& pObjectUserId) = 0;
};
