...
int _getSimilarityCoefFromGrd(const SemanticGrounding& pGrdExp1, const SemanticGrounding& pGrdExp2) {
...
int _getSimilarityCoefFromGrdExp(const GroundedExpression& pGrdExp1, const GroundedExpression& pGrdExp2) {
