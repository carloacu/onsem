            ...
            if (itObject != pGrdExp.children.end()) {
                ...
                if (ojectGrdExp != nullptr
                    && (verbCpt.first == "verb_action_show"
                        ...
                        || SemExpGetter::getReferenceTypeFromGrd(ojectGrdExp->grounding())
                    ...
                    if (subWorkStruct.askForNewRecursion()) {
                        ...
                        controller::applyOperatorOnGrdExp(subWorkStruct, pMemViewer, *ojectGrdExp, {}, *ojectGrdExp);
                        ...
                        pWorkStruct.addAnswer(ContextualAnnotation::ANSWER,
                                              allAnsw_knowAndGrdExp.getGrdExp().clone(),
            ...
            if (itObject != pGrdExp.children.end()) {
                ...
                if (ojectGrdExpPtr != nullptr) {
                    ...
                    if (genericGrdPtr != nullptr
                        ...
                        pWorkStruct.addAnswerWithoutReferences(ContextualAnnotation::REMOVEALLCONDITIONS,
