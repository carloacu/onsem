...
public:
    ...
    void writeOutputText(std::list<std::unique_ptr<SynthesizerResult> >& pNaturalLanguageResult,
...
protected:
    ...
    static void _addAWord(std::string& pNaturalLanguageText, const std::string& pStrToAdd, bool pBeginOfASentence);

    void _add2WordsToMerge(const std::string& pWord1, const std::string& pWord2, const std::string& pWordResult);
};
