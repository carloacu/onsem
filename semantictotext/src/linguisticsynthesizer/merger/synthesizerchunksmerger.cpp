...
void _addPrioritytoOutList(std::map<std::size_t, std::list<std::list<WordToSynthesize>*>>& pPriorities,
...
void SynthesizerChunksMerger::_writeDurationLocationAndTimeInGoodOrder(std::list<WordToSynthesize>& pOut,
