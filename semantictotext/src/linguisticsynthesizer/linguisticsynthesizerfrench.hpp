...
public:
    ...
    virtual const Linguisticsynthesizergrounding& getSyntGrounding() const { return _syntGrounding; }

    virtual const TokensToStringConverter& getTokenToStrConverter() const { return _tokenToStrConverter; }

protected:
    virtual const SynthesizerChunksMerger& _getChunksMerger() const { return _syntGrounding.getChunksMerger(); }
    ...
    bool _tryToWriteTopicBeforeVerb(std::list<WordToSynthesize>& pOut, const SemanticExpression& pSemExp) const;

    virtual void _getBeginOfWithChild(std::list<WordToSynthesize>& pOut) const;

    virtual void _getBeginOfWithoutChild(std::list<WordToSynthesize>& pOut) const;

    virtual void _getBeginOfForChild(std::list<WordToSynthesize>& pOut, const SemanticExpression& pSemExp) const;

    virtual void _getBeginOfReceiverOfNounChild(std::list<WordToSynthesize>& pOut, const SemanticExpression&) const;

    virtual void _getThanWord(std::list<WordToSynthesize>& pOut,
                              const mystd::unique_propagate_const<UniqueSemanticExpression>& pWhatIsComparedExp) const;

    virtual void _getBeginOfMitigationChild(std::list<WordToSynthesize>& pOut) const;

    virtual void _getBeginOfYesOrNoSubordonate(std::list<WordToSynthesize>& pOut) const;
    ...
    virtual void _getWheneverCondition(std::list<WordToSynthesize>& pOut) const;
    ...
    virtual void _writeAnythingHumanQuantity(OutSentence& pOutSentence) const;
    ...
    virtual void _getThenWord(std::list<WordToSynthesize>& pOut) const;

    virtual void _getElseWord(std::list<WordToSynthesize>& pOut) const;
