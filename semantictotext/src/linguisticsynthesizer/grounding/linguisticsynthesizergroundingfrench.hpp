...
public:
    ...
    virtual const SynthesizerChunksMerger& getChunksMerger() const { return _chunksMerger; }
...
protected:
    ...
    virtual bool _doWeHaveToPutSubMeaningBeforeOrAfterTheWord(const SynthesizerCurrentContext& pContext,
    ...
    virtual void _getAllWord(std::list<WordToSynthesize>& pOut, const SynthesizerCurrentContext& pContext) const;
    virtual void _getEveryWord(std::list<WordToSynthesize>& pOut, const SynthesizerCurrentContext& pContext) const;
...
private:
    ...
    PartOfSpeech _writeRelativePersonObject(std::list<WordToSynthesize>& pOut,
                                            RelativePerson pRelativePerson,
                                            SemanticGenderType pGender,
                                            SemanticReferenceType pReferenceType,
                                            bool pHasToBeCompletedFromContext,
    ...
    void _getSeWord(std::list<WordToSynthesize>& pOut, RelativePerson pRelativePerson) const;
};
