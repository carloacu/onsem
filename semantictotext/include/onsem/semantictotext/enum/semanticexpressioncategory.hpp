...
enum class SemanticExpressionCategory { ONSEM_SEMANTICEXPRESSIONCATEGORY_TABLE };
#undef ADD_ONSEM_SEMANTICEXPRESSIONCATEGORY

#define ADD_ONSEM_SEMANTICEXPRESSIONCATEGORY(a, b) b,
static const std::vector<std::string> _semanticExpressionCategory_toStr = {ONSEM_SEMANTICEXPRESSIONCATEGORY_TABLE};
#undef ADD_ONSEM_SEMANTICEXPRESSIONCATEGORY

#undef ONSEM_SEMANTICEXPRESSIONCATEGORY_TABLE

static inline char semanticExpressionCategory_toChar(SemanticExpressionCategory pSemanticExpressionCategory) {
    return static_cast<char>(pSemanticExpressionCategory);
}

static inline std::string semanticExpressionCategory_toStr(SemanticExpressionCategory pSemanticExpressionCategory) {
