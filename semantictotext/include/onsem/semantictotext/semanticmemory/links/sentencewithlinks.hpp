...
struct ONSEMSEMANTICTOTEXT_API SemanticTriggerAxiomId {
    ...
    SemanticTriggerAxiomId(std::size_t pNbOfAxioms, std::size_t pIdOfAxiom, SemanticExpressionType pSemExpType);
    SemanticTriggerAxiomId(std::size_t pNbOfAxioms, std::size_t pIdOfAxiom, ListExpressionType pListExpType);
    bool isEmpty() const;
...
struct ONSEMSEMANTICTOTEXT_API SentenceWithLinks : public ReferencesGetter {
    SentenceWithLinks(InformationType pInformationType, ExpressionWithLinks& pSemExpWrappedForMemory);
